...
For comprehensive descriptions of every class and function see the [API Reference](https://docs.aiagentsforce.com/api_reference/).

## Installation

- [How to: install AI Agents Force packages](/docs/how_to/installation/)
- [How to: use AI Agents Force with different Pydantic versions](/docs/how_to/pydantic_compatibility)

## Key features

This highlights functionality that is core to using AI Agents Force.
...
[AI Agents Force Expression Language](/docs/concepts/lcel) is a way to create arbitrary custom chains. It is built on the [Runnable](https://docs.aiagentsforce.com/api_reference/core/runnables/aiagentsforce_core.runnables.base.Runnable.html) protocol.
...
What AI Agents Force calls [LLMs](/docs/concepts/text_llms) are older forms of language models that take a string in and output a string.
...
AI Agents Force [Tools](/docs/concepts/tools) contain a description of the tool (to pass to the language model) as well as the implementation of the function to call. Refer [here](/docs/integrations/tools/) for a list of pre-buit tools. 
...
- [How to: use legacy AI Agents Force Agents (AgentExecutor)](/docs/how_to/agent_executor)
- [How to: migrate from legacy AI Agents Force agents to LangGraph](/docs/how_to/migrate_agent)
...
All of AI Agents Force components can easily be extended to support your own versions.
...
### Serialization
- [How to: save and load AI Agents Force objects](/docs/how_to/serialization)
...
LangGraph is an extension of AI Agents Force aimed at
...
It seamlessly integrates with AI Agents Force and LangGraph, and you can use it to inspect and debug individual steps of your chains and agents as you build.
...
relevant to AI Agents Force below:
