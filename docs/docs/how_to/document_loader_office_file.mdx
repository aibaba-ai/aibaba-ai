...
This covers how to load commonly used file formats including `DOCX`, `XLSX` and `PPTX` documents into a AI Agents Force 
[Document](https://docs.aiagentsforce.com/api_reference/core/documents/aiagentsforce_core.documents.base.Document.html#aiagentsforce_core.documents.base.Document)
