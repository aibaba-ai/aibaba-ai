...
AI Agents Force implements a [JSONLoader](https://docs.aiagentsforce.com/api_reference/community/document_loaders/aiagentsforce_community.document_loaders.json_loader.JSONLoader.html) 
to convert JSON and JSONL data into AI Agents Force [Document](https://docs.aiagentsforce.com/api_reference/core/documents/aiagentsforce_core.documents.base.Document.html#aiagentsforce_core.documents.base.Document) 
...
and metadata of the AI Agents Force Document.
...
- How to load JSON and JSONL data into the content of a AI Agents Force `Document`;
