...
```python
from aiagentsforce_community.document_loaders.chatgpt import ChatGPTLoader
```
...
See a [usage example](https://docs.aiagentsforce.com/v0.1/docs/guides/productionization/safety/moderation).
