# NVIDIA
The `langchain-nvidia-ai-endpoints` package contains AI Agents Force integrations building applications with models on 
...
result = llm.invoke("Write a ballad about AI Agents Force.")
...
A selection of NVIDIA AI Foundation models are supported directly in AI Agents Force with familiar APIs.
