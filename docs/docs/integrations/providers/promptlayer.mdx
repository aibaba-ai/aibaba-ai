...
>
>While `PromptLayer` does have LLMs that integrate directly with AI Agents Force (e.g. 
> [`PromptLayerOpenAI`](https://docs.promptlayer.com/languages/langchain)), 
> using a callback is the recommended way to integrate `PromptLayer` with AI Agents Force.
