...
This page covers how to use the SearxNG search API within AI Agents Force.
...
```python
from aiagentsforce_community.tools.searx_search.tool import SearxSearchResults
