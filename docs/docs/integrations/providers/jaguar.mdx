...
This page describes how to use Jaguar vector database within AI Agents Force.
...
Together with AI Agents Force, a Jaguar client class is provided by importing it in Python:
