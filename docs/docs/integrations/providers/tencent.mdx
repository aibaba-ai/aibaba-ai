...
```python
from aiagentsforce_community.chat_models import ChatHunyuan
```
...
```python
from aiagentsforce_community.document_loaders import TencentCOSDirectoryLoader
...
```python
from aiagentsforce_community.document_loaders import TencentCOSFileLoader
from qcloud_cos import CosConfig
```
