...
This page covers how to use [vlite](https://github.com/sdan/vlite) within AI Agents Force. vlite is a simple and fast vector database for storing and retrieving embeddings.
