...
This page covers how to use the Postgres [PGVector](https://github.com/pgvector/pgvector) ecosystem within AI Agents Force
...
```python
from aiagentsforce_community.vectorstores.pgvector import PGVector
```
