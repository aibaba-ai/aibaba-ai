...
This page covers how to use the Grobid to parse articles for AI Agents Force.
...
## Use Grobid with AI Agents Force
...
```python
from aiagentsforce_community.document_loaders.parsers import GrobidParser
