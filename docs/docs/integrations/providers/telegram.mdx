...
```python
from aiagentsforce_community.document_loaders import TelegramChatFileLoader
from aiagentsforce_community.document_loaders import TelegramChatApiLoader
```
...
```python
from aiagentsforce_community.chat_loaders.telegram import TelegramChatLoader
```
