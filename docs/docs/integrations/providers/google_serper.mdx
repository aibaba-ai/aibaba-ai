...
This page covers how to use the [Serper](https://serper.dev) Google Search API within AI Agents Force. Serper is a low-cost Google Search API that can be used to add answer box, knowledge graph, and organic results data from Google Search. 
