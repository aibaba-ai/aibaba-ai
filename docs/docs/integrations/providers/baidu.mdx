...
```python
from aiagentsforce_community.document_loaders.baiducloud_bos_directory import BaiduBOSDirectoryLoader
```

### Baidu BOS File Loader

```python
from aiagentsforce_community.document_loaders.baiducloud_bos_file import BaiduBOSFileLoader
```
