...
[using AI Agents Force with CrateDB]. See also [all features of CrateDB]
to learn about other functionality provided by CrateDB.


## Features
The CrateDB adapter for AI Agents Force provides APIs to use CrateDB as vector store,
...
loader = UnstructuredURLLoader(urls=["https://github.com/AI-Agents-Force-SDK/langchain/raw/refs/tags/langchain-core==0.3.28/docs/docs/how_to/state_of_the_union.txt"])
...
[using AI Agents Force with CrateDB]: https://cratedb.com/docs/guide/integrate/langchain/
