...
```python
from aiagentsforce_community.document_loaders.larksuite import LarkSuiteDocLoader
```
...
```python
from aiagentsforce_community.document_loaders.larksuite import LarkSuiteWikiLoader
```
