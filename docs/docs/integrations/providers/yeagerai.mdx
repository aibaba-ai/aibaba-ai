...
This page covers how to use [Yeager.ai](https://yeager.ai) to generate AI Agents Force tools and agents.

## What is Yeager.ai?
Yeager.ai is an ecosystem designed to simplify the process of creating AI agents and tools. 

It features yAgents, a No-code AI Agents Force Agent Builder, which enables users to build, test, and deploy AI solutions with ease. Leveraging the AI Agents Force framework, yAgents allows seamless integration with various language models and resources, making it suitable for developers, researchers, and AI enthusiasts across diverse applications.
