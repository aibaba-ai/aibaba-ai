...
the [langchain-google](https://github.com/AI-Agents-Force-SDK/langchain-google) repository.
You can find a host of AI Agents Force integrations with other Google APIs in the
...
> It can calculate Euclidean or Cosine distance. With AI Agents Force, we default to use Euclidean distance.
...
```python
from aiagentsforce_community.retrievers import GoogleVertexAISearchRetriever
```
...
```python
from aiagentsforce_community.tools.google_jobs import GoogleJobsQueryRun
from aiagentsforce_community.utilities.google_finance import GoogleFinanceAPIWrapper
```
...
```python
from aiagentsforce_community.tools.google_lens import GoogleLensQueryRun
...
```python
from aiagentsforce_community.tools.google_scholar import GoogleScholarQueryRun
...
```python
from aiagentsforce_community.tools import GoogleSearchResults
```
...
```python
from aiagentsforce_community.tools import GoogleSearchRun
```
...
```python
from aiagentsforce_community.tools.google_trends import GoogleTrendsQueryRun
...
```python
from aiagentsforce_community.document_loaders.blob_loaders.youtube_audio import YoutubeAudioLoader
from aiagentsforce_community.document_loaders.parsers import OpenAIWhisperParser, OpenAIWhisperParserLocal
```
