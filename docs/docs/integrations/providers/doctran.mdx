...
```python
from aiagentsforce_community.document_loaders import DoctranQATransformer
```
### Property Extractor
...
```python
from aiagentsforce_community.document_loaders import DoctranPropertyExtractor
```
### Document Translator
...
```python
from aiagentsforce_community.document_loaders import DoctranTextTranslator
```
