...
```python
from aiagentsforce_community.chat_models.kinetica import ChatKinetica
```
...
```python
from aiagentsforce_community.vectorstores import Kinetica
```

## Document Loader

The Kinetica Document loader can be used to load AI Agents Force Documents from the
Kinetica database.
