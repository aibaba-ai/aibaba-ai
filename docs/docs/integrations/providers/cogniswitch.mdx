...
```python
from aiagentsforce_community.tools.cogniswitch.tool import CogniswitchKnowledgeRequest
```
...
```python
from aiagentsforce_community.tools.cogniswitch.tool import CogniswitchKnowledgeSourceFile
```
...
```python
from aiagentsforce_community.tools.cogniswitch.tool import CogniswitchKnowledgeSourceURL
```
...
```python
from aiagentsforce_community.tools.cogniswitch.tool import CogniswitchKnowledgeStatus
```
