...
```python
from aiagentsforce_community.document_loaders import AzureBlobStorageContainerLoader
```

See a [usage example for the Azure Files](/docs/integrations/document_loaders/azure_blob_storage_file).

```python
from aiagentsforce_community.document_loaders import AzureBlobStorageFileLoader
```
...
```python
from aiagentsforce_community.document_loaders import OneDriveLoader
```
...
```python
from aiagentsforce_community.document_loaders import OneDriveFileLoader
```
...
```python
from aiagentsforce_community.document_loaders.sharepoint import SharePointLoader
```
...
```python
from aiagentsforce_community.vectorstores import AzureCosmosDBNoSQLVectorSearch
```
...
Since Azure Database for PostgreSQL is open-source Postgres, you can use the [AI Agents Force's Postgres support](/docs/integrations/vectorstores/pgvector/) to connect to Azure Database for PostgreSQL.
...
You need to [enable pgvector extension](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/how-to-use-pgvector) in your database to use Postgres as a vector store. Once you have the extension enabled, you can use the [PGVector in AI Agents Force](/docs/integrations/vectorstores/pgvector/) to connect to Azure Database for PostgreSQL. 
...
```python
from aiagentsforce_community.agent_toolkits import azure_ai_services
```
...
- Image Analysis: [AzureAiServicesImageAnalysisTool](https://docs.aiagentsforce.com/api_reference/community/tools/aiagentsforce_community.tools.azure_ai_services.image_analysis.AzureAiServicesImageAnalysisTool.html)
- Document Intelligence: [AzureAiServicesDocumentIntelligenceTool](https://docs.aiagentsforce.com/api_reference/community/tools/aiagentsforce_community.tools.azure_ai_services.document_intelligence.AzureAiServicesDocumentIntelligenceTool.html)
- Speech to Text: [AzureAiServicesSpeechToTextTool](https://docs.aiagentsforce.com/api_reference/community/tools/aiagentsforce_community.tools.azure_ai_services.speech_to_text.AzureAiServicesSpeechToTextTool.html)
- Text to Speech: [AzureAiServicesTextToSpeechTool](https://docs.aiagentsforce.com/api_reference/community/tools/aiagentsforce_community.tools.azure_ai_services.text_to_speech.AzureAiServicesTextToSpeechTool.html)
- Text Analytics for Health: [AzureAiServicesTextAnalyticsForHealthTool](https://docs.aiagentsforce.com/api_reference/community/tools/aiagentsforce_community.tools.azure_ai_services.text_analytics_for_health.AzureAiServicesTextAnalyticsForHealthTool.html)
...
```python
from aiagentsforce_community.tools.office365 import O365CreateDraftMessage
from aiagentsforce_community.tools.office365 import O365SearchEmails
from aiagentsforce_community.tools.office365 import O365SearchEvents
from aiagentsforce_community.tools.office365 import O365SendEvent
from aiagentsforce_community.tools.office365 import O365SendMessage
```
...
```python
from aiagentsforce_community.agent_toolkits import PowerBIToolkit
...
```python
from aiagentsforce_community.tools.powerbi.tool import InfoPowerBITool
from aiagentsforce_community.tools.powerbi.tool import ListPowerBITool
from aiagentsforce_community.tools.powerbi.tool import QueryPowerBITool
```
...
```python
from aiagentsforce_community.tools.playwright import ClickTool
from aiagentsforce_community.tools.playwright import CurrentWebPageTool
from aiagentsforce_community.tools.playwright import ExtractHyperlinksTool
from aiagentsforce_community.tools.playwright import ExtractTextTool
from aiagentsforce_community.tools.playwright import GetElementsTool
from aiagentsforce_community.tools.playwright import NavigateTool
from aiagentsforce_community.tools.playwright import NavigateBackTool
```
...
See [usage examples](https://docs.aiagentsforce.com/v0.1/docs/guides/productionization/safety/presidio_data_anonymization).
