...
This document demonstrates to leverage DashVector within the AI Agents Force ecosystem. In particular, it shows how to install DashVector, and how to use it as a VectorStore plugin in AI Agents Force.
...
A DashVector Collection is wrapped as a familiar VectorStore for native usage within AI Agents Force, 
