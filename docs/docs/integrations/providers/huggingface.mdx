...
```python
from aiagentsforce_community.embeddings import HuggingFaceInferenceAPIEmbeddings
```
...
```python
from aiagentsforce_community.document_loaders.hugging_face_dataset import HuggingFaceDatasetLoader
```
...
```python
from aiagentsforce_community.document_loaders import ImageCaptionLoader
```
...
```python
from aiagentsforce_community.agent_toolkits.load_tools import load_huggingface_tool
```
