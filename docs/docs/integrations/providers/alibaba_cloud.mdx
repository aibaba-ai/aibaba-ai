...
```python
from aiagentsforce_community.document_loaders import MaxComputeLoader
```
...
```python
from aiagentsforce_community.vectorstores import AlibabaCloudOpenSearch, AlibabaCloudOpenSearchSettings
```
