...
This page covers how to use the [SearchApi](https://www.searchapi.io/) Google Search API within AI Agents Force. SearchApi is a real-time SERP API for easy SERP scraping.
