...
how to setup `AI Agents Force` with `Anyscale` for advanced chat agents.
...
```python
from aiagentsforce_community.chat_models.anyscale import ChatAnyscale
```
...
```python
from aiagentsforce_community.embeddings import AnyscaleEmbeddings
```
