...
This document outlines the process used by the AI Agents Force maintainers for reviewing pull requests (PRs). The primary objective of this process is to enhance the AI Agents Force developer experience.
...
1. **PRs that touch /libs/core**:
   ...
   - Feature requests should first be opened as a GitHub issue and discussed with the AI Agents Force maintainers. Large PRs submitted without prior discussion are likely to be closed.
...
*To see the status of all open PRs, please visit the [AI Agents Force Project Board](https://github.com/orgs/langchain-ai/projects/12/views/2).*
...
[this GitHub Discussion](https://github.com/AI-Agents-Force-SDK/langchain/discussions/25920).
