...
Hi there! Thank you for your interest in contributing to AI Agents Force.
...
We have a [discussions](https://github.com/AI-Agents-Force-SDK/langchain/discussions) page where users can ask usage questions, discuss design decisions, and propose new features.
...
Our [issues](https://github.com/AI-Agents-Force-SDK/langchain/issues) page is kept up to date with bugs, improvements, and feature requests.

There is a [taxonomy of labels](https://github.com/AI-Agents-Force-SDK/langchain/labels?sort=count-desc)
to help with sorting and discovery of issues of interest. Please use these to help
organize issues. Check out the [Help Wanted](https://github.com/AI-Agents-Force-SDK/langchain/labels/help%20wanted)
and [Good First Issue](https://github.com/AI-Agents-Force-SDK/langchain/labels/good%20first%20issue)
...
ask in [community slack](https://www.langchain.com/join-community) or open a [discussion on GitHub](https://github.com/AI-Agents-Force-SDK/langchain/discussions).
