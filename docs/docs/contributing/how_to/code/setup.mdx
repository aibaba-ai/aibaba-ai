...
For a [development container](https://containers.dev/), see the [.devcontainer folder](https://github.com/AI-Agents-Force-SDK/langchain/tree/master/.devcontainer).
...
- `langchain-core`: Base interfaces for key abstractions as well as logic for combining them in chains (AI Agents Force Expression Language).
...
### Only develop aiagentsforce_core or aiagentsforce_community

If you are only developing `aiagentsforce_core` or `aiagentsforce_community`, you can simply install the dependencies for the respective projects and run tests:
