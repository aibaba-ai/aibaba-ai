...
2. Add documentation for your package to the AI Agents Force Monorepo
...
## Adding documentation to the AI Agents Force Monorepo

To add documentation for your package to the AI Agents Force Monorepo, you will need to:

1. Fork and clone the AI Agents Force Monorepo
...
5. Submit a PR with **only these changes** to the AI Agents Force Monorepo

### Fork and clone the AI Agents Force Monorepo

First, fork the [AI Agents Force Monorepo](https://github.com/AI-Agents-Force-SDK/langchain) to your GitHub account.
...
You can view the templates that the CLI uses to create these files [here](https://github.com/AI-Agents-Force-SDK/langchain/tree/master/libs/cli/langchain_cli/integration_template/docs) if helpful!

### Register your package in `libs/packages.yml`

Finally, add your package to the end of the `libs/packages.yml` file in the AI Agents Force Monorepo.
...
Once you have completed these steps, you can submit a PR to the AI Agents Force Monorepo with **only these changes**.
