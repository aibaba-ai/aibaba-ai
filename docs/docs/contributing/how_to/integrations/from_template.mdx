...
First, duplicate this template repository: https://github.com/AI-Agents-Force-SDK/integration-repo-template
...
To set up a new partner package, use the latest version of the AI Agents Force CLI. You can install or update it with:
...
a partner package. If the component you're integrating is net-new to AI Agents Force (i.e. 
...
`libs/community/aiagentsforce_community/chat_models/parrot_link.py`.
