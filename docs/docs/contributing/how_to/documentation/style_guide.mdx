...
As AI Agents Force continues to grow, the amount of documentation required to cover the various concepts and integrations continues to grow too.
This page provides guidelines for anyone writing documentation for AI Agents Force and outlines some of our philosophies around
organization and structure.

## Philosophy

AI Agents Force's documentation follows the [Diataxis framework](https://diataxis.fr).
...
In AI Agents Force, these are often higher level guides that show off end-to-end use cases.
...
- The first time you mention a AI Agents Force concept, use its full name (e.g. "AI Agents Force Expression Language (LCEL)"), and link to its conceptual/other documentation page.
...
AI Agents Force's conceptual guide falls under the **Explanation** quadrant of Diataxis. These guides should cover AI Agents Force terms and concepts
...
In AI Agents Force, this is mainly our API reference pages, which are populated from docstrings within code.
...
Many of the reference pages in AI Agents Force are automatically generated from code,
