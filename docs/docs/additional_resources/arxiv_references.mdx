...
|------------------|---------|-------------------|------------------------|
| `2403.14403v2` [Adaptive-RAG: Learning to Adapt Retrieval-Augmented Large Language Models through Question Complexity](http://arxiv.org/abs/2403.14403v2) | Soyeong Jeong, Jinheon Baek, Sukmin Cho,  et al. | 2024&#8209;03&#8209;21 | `Docs:` [docs/concepts](https://https://docs.aiagentsforce.com//concepts)
| `2402.03620v1` [Self-Discover: Large Language Models Self-Compose Reasoning Structures](http://arxiv.org/abs/2402.03620v1) | Pei Zhou, Jay Pujara, Xiang Ren,  et al. | 2024&#8209;02&#8209;06 | `Cookbook:` [Self-Discover](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/self-discover.ipynb)
| `2402.03367v2` [RAG-Fusion: a New Take on Retrieval-Augmented Generation](http://arxiv.org/abs/2402.03367v2) | Zackary Rackauckas | 2024&#8209;01&#8209;31 | `Docs:` [docs/concepts](https://https://docs.aiagentsforce.com//concepts)
| `2401.18059v1` [RAPTOR: Recursive Abstractive Processing for Tree-Organized Retrieval](http://arxiv.org/abs/2401.18059v1) | Parth Sarthi, Salman Abdullah, Aditi Tuli,  et al. | 2024&#8209;01&#8209;31 | `Cookbook:` [Raptor](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/RAPTOR.ipynb)
| `2401.15884v2` [Corrective Retrieval Augmented Generation](http://arxiv.org/abs/2401.15884v2) | Shi-Qi Yan, Jia-Chen Gu, Yun Zhu,  et al. | 2024&#8209;01&#8209;29 | `Docs:` [docs/concepts](https://https://docs.aiagentsforce.com//concepts), `Cookbook:` [Langgraph Crag](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/langgraph_crag.ipynb)
| `2401.08500v1` [Code Generation with AlphaCodium: From Prompt Engineering to Flow Engineering](http://arxiv.org/abs/2401.08500v1) | Tal Ridnik, Dedy Kredo, Itamar Friedman | 2024&#8209;01&#8209;16 | `Docs:` [docs/concepts](https://https://docs.aiagentsforce.com//concepts)
| `2401.04088v1` [Mixtral of Experts](http://arxiv.org/abs/2401.04088v1) | Albert Q. Jiang, Alexandre Sablayrolles, Antoine Roux,  et al. | 2024&#8209;01&#8209;08 | `Cookbook:` [Together Ai](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/together_ai.ipynb)
| `2312.06648v2` [Dense X Retrieval: What Retrieval Granularity Should We Use?](http://arxiv.org/abs/2312.06648v2) | Tong Chen, Hongwei Wang, Sihao Chen,  et al. | 2023&#8209;12&#8209;11 | `Template:` [propositional-retrieval](https://https://docs.aiagentsforce.com//templates/propositional-retrieval)
| `2311.09210v1` [Chain-of-Note: Enhancing Robustness in Retrieval-Augmented Language Models](http://arxiv.org/abs/2311.09210v1) | Wenhao Yu, Hongming Zhang, Xiaoman Pan,  et al. | 2023&#8209;11&#8209;15 | `Template:` [chain-of-note-wiki](https://https://docs.aiagentsforce.com//templates/chain-of-note-wiki)
| `2310.11511v1` [Self-RAG: Learning to Retrieve, Generate, and Critique through Self-Reflection](http://arxiv.org/abs/2310.11511v1) | Akari Asai, Zeqiu Wu, Yizhong Wang,  et al. | 2023&#8209;10&#8209;17 | `Docs:` [docs/concepts](https://https://docs.aiagentsforce.com//concepts), `Cookbook:` [Langgraph Self Rag](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/langgraph_self_rag.ipynb)
| `2310.06117v2` [Take a Step Back: Evoking Reasoning via Abstraction in Large Language Models](http://arxiv.org/abs/2310.06117v2) | Huaixiu Steven Zheng, Swaroop Mishra, Xinyun Chen,  et al. | 2023&#8209;10&#8209;09 | `Docs:` [docs/concepts](https://https://docs.aiagentsforce.com//concepts), `Template:` [stepback-qa-prompting](https://https://docs.aiagentsforce.com//templates/stepback-qa-prompting), `Cookbook:` [Stepback-Qa](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/stepback-qa.ipynb)
| `2307.15337v3` [Skeleton-of-Thought: Prompting LLMs for Efficient Parallel Generation](http://arxiv.org/abs/2307.15337v3) | Xuefei Ning, Zinan Lin, Zixuan Zhou,  et al. | 2023&#8209;07&#8209;28 | `Template:` [skeleton-of-thought](https://https://docs.aiagentsforce.com//templates/skeleton-of-thought)
| `2307.09288v2` [Llama 2: Open Foundation and Fine-Tuned Chat Models](http://arxiv.org/abs/2307.09288v2) | Hugo Touvron, Louis Martin, Kevin Stone,  et al. | 2023&#8209;07&#8209;18 | `Cookbook:` [Semi Structured Rag](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/Semi_Structured_RAG.ipynb)
| `2307.03172v3` [Lost in the Middle: How Language Models Use Long Contexts](http://arxiv.org/abs/2307.03172v3) | Nelson F. Liu, Kevin Lin, John Hewitt,  et al. | 2023&#8209;07&#8209;06 | `Docs:` [docs/how_to/long_context_reorder](https://https://docs.aiagentsforce.com//how_to/long_context_reorder)
| `2305.14283v3` [Query Rewriting for Retrieval-Augmented Large Language Models](http://arxiv.org/abs/2305.14283v3) | Xinbei Ma, Yeyun Gong, Pengcheng He,  et al. | 2023&#8209;05&#8209;23 | `Template:` [rewrite-retrieve-read](https://https://docs.aiagentsforce.com//templates/rewrite-retrieve-read), `Cookbook:` [Rewrite](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/rewrite.ipynb)
| `2305.08291v1` [Large Language Model Guided Tree-of-Thought](http://arxiv.org/abs/2305.08291v1) | Jieyi Long | 2023&#8209;05&#8209;15 | `API:` [langchain_experimental.tot](https://docs.aiagentsforce.com/api_reference/experimental/tot.html), `Cookbook:` [Tree Of Thought](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/tree_of_thought.ipynb)
| `2305.04091v3` [Plan-and-Solve Prompting: Improving Zero-Shot Chain-of-Thought Reasoning by Large Language Models](http://arxiv.org/abs/2305.04091v3) | Lei Wang, Wanyu Xu, Yihuai Lan,  et al. | 2023&#8209;05&#8209;06 | `Cookbook:` [Plan And Execute Agent](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/plan_and_execute_agent.ipynb)
| `2305.02156v1` [Zero-Shot Listwise Document Reranking with a Large Language Model](http://arxiv.org/abs/2305.02156v1) | Xueguang Ma, Xinyu Zhang, Ronak Pradeep,  et al. | 2023&#8209;05&#8209;03 | `Docs:` [docs/how_to/contextual_compression](https://https://docs.aiagentsforce.com//how_to/contextual_compression), `API:` [langchain...LLMListwiseRerank](https://docs.aiagentsforce.com/api_reference/langchain/retrievers/langchain.retrievers.document_compressors.listwise_rerank.LLMListwiseRerank.html#)
| `2304.08485v2` [Visual Instruction Tuning](http://arxiv.org/abs/2304.08485v2) | Haotian Liu, Chunyuan Li, Qingyang Wu,  et al. | 2023&#8209;04&#8209;17 | `Cookbook:` [Semi Structured Multi Modal Rag Llama2](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/Semi_structured_multi_modal_RAG_LLaMA2.ipynb), [Semi Structured And Multi Modal Rag](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/Semi_structured_and_multi_modal_RAG.ipynb)
| `2304.03442v2` [Generative Agents: Interactive Simulacra of Human Behavior](http://arxiv.org/abs/2304.03442v2) | Joon Sung Park, Joseph C. O'Brien, Carrie J. Cai,  et al. | 2023&#8209;04&#8209;07 | `Cookbook:` [Generative Agents Interactive Simulacra Of Human Behavior](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/generative_agents_interactive_simulacra_of_human_behavior.ipynb), [Multiagent Bidding](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/multiagent_bidding.ipynb)
| `2303.17760v2` [CAMEL: Communicative Agents for "Mind" Exploration of Large Language Model Society](http://arxiv.org/abs/2303.17760v2) | Guohao Li, Hasan Abed Al Kader Hammoud, Hani Itani,  et al. | 2023&#8209;03&#8209;31 | `Cookbook:` [Camel Role Playing](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/camel_role_playing.ipynb)
| `2303.17580v4` [HuggingGPT: Solving AI Tasks with ChatGPT and its Friends in Hugging Face](http://arxiv.org/abs/2303.17580v4) | Yongliang Shen, Kaitao Song, Xu Tan,  et al. | 2023&#8209;03&#8209;30 | `API:` [langchain_experimental.autonomous_agents](https://docs.aiagentsforce.com/api_reference/experimental/autonomous_agents.html), `Cookbook:` [Hugginggpt](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/hugginggpt.ipynb)
| `2301.10226v4` [A Watermark for Large Language Models](http://arxiv.org/abs/2301.10226v4) | John Kirchenbauer, Jonas Geiping, Yuxin Wen,  et al. | 2023&#8209;01&#8209;24 | `API:` [aiagentsforce_community...OCIModelDeploymentTGI](https://api.python.langchain.com/en/latest/llms/aiagentsforce_community.llms.oci_data_science_model_deployment_endpoint.OCIModelDeploymentTGI.html#aiagentsforce_community.llms.oci_data_science_model_deployment_endpoint.OCIModelDeploymentTGI), [langchain_huggingface...HuggingFaceEndpoint](https://api.python.langchain.com/en/latest/llms/langchain_huggingface.llms.huggingface_endpoint.HuggingFaceEndpoint.html#langchain_huggingface.llms.huggingface_endpoint.HuggingFaceEndpoint), [aiagentsforce_community...HuggingFaceTextGenInference](https://api.python.langchain.com/en/latest/llms/aiagentsforce_community.llms.huggingface_text_gen_inference.HuggingFaceTextGenInference.html#aiagentsforce_community.llms.huggingface_text_gen_inference.HuggingFaceTextGenInference), [aiagentsforce_community...HuggingFaceEndpoint](https://api.python.langchain.com/en/latest/llms/aiagentsforce_community.llms.huggingface_endpoint.HuggingFaceEndpoint.html#aiagentsforce_community.llms.huggingface_endpoint.HuggingFaceEndpoint)
| `2212.10496v1` [Precise Zero-Shot Dense Retrieval without Relevance Labels](http://arxiv.org/abs/2212.10496v1) | Luyu Gao, Xueguang Ma, Jimmy Lin,  et al. | 2022&#8209;12&#8209;20 | `Docs:` [docs/concepts](https://https://docs.aiagentsforce.com//concepts), `API:` [langchain...HypotheticalDocumentEmbedder](https://api.python.langchain.com/en/latest/chains/langchain.chains.hyde.base.HypotheticalDocumentEmbedder.html#langchain.chains.hyde.base.HypotheticalDocumentEmbedder), `Template:` [hyde](https://https://docs.aiagentsforce.com//templates/hyde), `Cookbook:` [Hypothetical Document Embeddings](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/hypothetical_document_embeddings.ipynb)
| `2212.08073v1` [Constitutional AI: Harmlessness from AI Feedback](http://arxiv.org/abs/2212.08073v1) | Yuntao Bai, Saurav Kadavath, Sandipan Kundu,  et al. | 2022&#8209;12&#8209;15 | `Docs:` [docs/versions/migrating_chains/constitutional_chain](https://https://docs.aiagentsforce.com//versions/migrating_chains/constitutional_chain)
| `2212.07425v3` [Robust and Explainable Identification of Logical Fallacies in Natural Language Arguments](http://arxiv.org/abs/2212.07425v3) | Zhivar Sourati, Vishnu Priya Prasanna Venkatesh, Darshan Deshpande,  et al. | 2022&#8209;12&#8209;12 | `API:` [langchain_experimental.fallacy_removal](https://docs.aiagentsforce.com/api_reference/experimental/fallacy_removal.html)
| `2211.13892v2` [Complementary Explanations for Effective In-Context Learning](http://arxiv.org/abs/2211.13892v2) | Xi Ye, Srinivasan Iyer, Asli Celikyilmaz,  et al. | 2022&#8209;11&#8209;25 | `API:` [aiagentsforce_core...MaxMarginalRelevanceExampleSelector](https://api.python.langchain.com/en/latest/example_selectors/aiagentsforce_core.example_selectors.semantic_similarity.MaxMarginalRelevanceExampleSelector.html#aiagentsforce_core.example_selectors.semantic_similarity.MaxMarginalRelevanceExampleSelector)
| `2211.10435v2` [PAL: Program-aided Language Models](http://arxiv.org/abs/2211.10435v2) | Luyu Gao, Aman Madaan, Shuyan Zhou,  et al. | 2022&#8209;11&#8209;18 | `API:` [langchain_experimental.pal_chain](https://docs.aiagentsforce.com/api_reference/experimental/pal_chain.html), [langchain_experimental...PALChain](https://api.python.langchain.com/en/latest/pal_chain/langchain_experimental.pal_chain.base.PALChain.html#langchain_experimental.pal_chain.base.PALChain), `Cookbook:` [Program Aided Language Model](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/program_aided_language_model.ipynb)
| `2210.11934v2` [An Analysis of Fusion Functions for Hybrid Retrieval](http://arxiv.org/abs/2210.11934v2) | Sebastian Bruch, Siyu Gai, Amir Ingber | 2022&#8209;10&#8209;21 | `Docs:` [docs/concepts](https://https://docs.aiagentsforce.com//concepts)
| `2210.03629v3` [ReAct: Synergizing Reasoning and Acting in Language Models](http://arxiv.org/abs/2210.03629v3) | Shunyu Yao, Jeffrey Zhao, Dian Yu,  et al. | 2022&#8209;10&#8209;06 | `Docs:` [docs/integrations/tools/ionic_shopping](https://https://docs.aiagentsforce.com//integrations/tools/ionic_shopping), [docs/integrations/providers/cohere](https://https://docs.aiagentsforce.com//integrations/providers/cohere), [docs/concepts](https://https://docs.aiagentsforce.com//concepts), `API:` [langchain...create_react_agent](https://api.python.langchain.com/en/latest/agents/langchain.agents.react.agent.create_react_agent.html#langchain.agents.react.agent.create_react_agent), [langchain...TrajectoryEvalChain](https://api.python.langchain.com/en/latest/evaluation/langchain.evaluation.agents.trajectory_eval_chain.TrajectoryEvalChain.html#langchain.evaluation.agents.trajectory_eval_chain.TrajectoryEvalChain)
| `2209.10785v2` [Deep Lake: a Lakehouse for Deep Learning](http://arxiv.org/abs/2209.10785v2) | Sasun Hambardzumyan, Abhinav Tuli, Levon Ghukasyan,  et al. | 2022&#8209;09&#8209;22 | `Docs:` [docs/integrations/providers/activeloop_deeplake](https://https://docs.aiagentsforce.com//integrations/providers/activeloop_deeplake)
| `2205.13147v4` [Matryoshka Representation Learning](http://arxiv.org/abs/2205.13147v4) | Aditya Kusupati, Gantavya Bhatt, Aniket Rege,  et al. | 2022&#8209;05&#8209;26 | `Docs:` [docs/integrations/providers/snowflake](https://https://docs.aiagentsforce.com//integrations/providers/snowflake)
| `2205.12654v1` [Bitext Mining Using Distilled Sentence Representations for Low-Resource Languages](http://arxiv.org/abs/2205.12654v1) | Kevin Heffernan, Onur Çelebi, Holger Schwenk | 2022&#8209;05&#8209;25 | `API:` [aiagentsforce_community...LaserEmbeddings](https://api.python.langchain.com/en/latest/embeddings/aiagentsforce_community.embeddings.laser.LaserEmbeddings.html#aiagentsforce_community.embeddings.laser.LaserEmbeddings)
| `2204.00498v1` [Evaluating the Text-to-SQL Capabilities of Large Language Models](http://arxiv.org/abs/2204.00498v1) | Nitarshan Rajkumar, Raymond Li, Dzmitry Bahdanau | 2022&#8209;03&#8209;15 | `Docs:` [docs/tutorials/sql_qa](https://https://docs.aiagentsforce.com//tutorials/sql_qa), `API:` [aiagentsforce_community...SQLDatabase](https://api.python.langchain.com/en/latest/utilities/aiagentsforce_community.utilities.sql_database.SQLDatabase.html#aiagentsforce_community.utilities.sql_database.SQLDatabase), [aiagentsforce_community...SparkSQL](https://api.python.langchain.com/en/latest/utilities/aiagentsforce_community.utilities.spark_sql.SparkSQL.html#aiagentsforce_community.utilities.spark_sql.SparkSQL)
...
| `2112.01488v3` [ColBERTv2: Effective and Efficient Retrieval via Lightweight Late Interaction](http://arxiv.org/abs/2112.01488v3) | Keshav Santhanam, Omar Khattab, Jon Saad-Falcon,  et al. | 2021&#8209;12&#8209;02 | `Docs:` [docs/integrations/retrievers/ragatouille](https://https://docs.aiagentsforce.com//integrations/retrievers/ragatouille), [docs/integrations/providers/ragatouille](https://https://docs.aiagentsforce.com//integrations/providers/ragatouille), [docs/concepts](https://https://docs.aiagentsforce.com//concepts), [docs/integrations/providers/dspy](https://https://docs.aiagentsforce.com//integrations/providers/dspy)
| `2103.00020v1` [Learning Transferable Visual Models From Natural Language Supervision](http://arxiv.org/abs/2103.00020v1) | Alec Radford, Jong Wook Kim, Chris Hallacy,  et al. | 2021&#8209;02&#8209;26 | `API:` [langchain_experimental.open_clip](https://docs.aiagentsforce.com/api_reference/experimental/open_clip.html)
| `2005.14165v4` [Language Models are Few-Shot Learners](http://arxiv.org/abs/2005.14165v4) | Tom B. Brown, Benjamin Mann, Nick Ryder,  et al. | 2020&#8209;05&#8209;28 | `Docs:` [docs/concepts](https://https://docs.aiagentsforce.com//concepts)
| `2005.11401v4` [Retrieval-Augmented Generation for Knowledge-Intensive NLP Tasks](http://arxiv.org/abs/2005.11401v4) | Patrick Lewis, Ethan Perez, Aleksandra Piktus,  et al. | 2020&#8209;05&#8209;22 | `Docs:` [docs/concepts](https://https://docs.aiagentsforce.com//concepts)
...
- **AI Agents Force:**
   ...
   - **Documentation:** [docs/concepts](https://https://docs.aiagentsforce.com//concepts)
...
- **AI Agents Force:**
   ...
   - **Cookbook:** [self-discover](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/self-discover.ipynb)
...
- **AI Agents Force:**
   ...
   - **Cookbook:** [RAPTOR](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/RAPTOR.ipynb)
...
- **AI Agents Force:**
   ...
   - **Documentation:** [docs/concepts](https://https://docs.aiagentsforce.com//concepts)
   - **Cookbook:** [langgraph_crag](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/langgraph_crag.ipynb)
...
- **AI Agents Force:**
   ...
   - **Cookbook:** [together_ai](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/together_ai.ipynb)
...
- **AI Agents Force:**
   ...
   - **Template:** [propositional-retrieval](https://https://docs.aiagentsforce.com//templates/propositional-retrieval)
...
- **AI Agents Force:**
   ...
   - **Template:** [chain-of-note-wiki](https://https://docs.aiagentsforce.com//templates/chain-of-note-wiki)
...
- **AI Agents Force:**
   ...
   - **Documentation:** [docs/concepts](https://https://docs.aiagentsforce.com//concepts)
   - **Cookbook:** [langgraph_self_rag](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/langgraph_self_rag.ipynb)
...
- **AI Agents Force:**
   ...
   - **Documentation:** [docs/concepts](https://https://docs.aiagentsforce.com//concepts)
   - **Template:** [stepback-qa-prompting](https://https://docs.aiagentsforce.com//templates/stepback-qa-prompting)
   - **Cookbook:** [stepback-qa](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/stepback-qa.ipynb)
...
- **AI Agents Force:**
   ...
   - **Template:** [skeleton-of-thought](https://https://docs.aiagentsforce.com//templates/skeleton-of-thought)
...
- **AI Agents Force:**
   ...
   - **Cookbook:** [Semi_Structured_RAG](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/Semi_Structured_RAG.ipynb)
...
- **AI Agents Force:**
   ...
   - **Documentation:** [docs/how_to/long_context_reorder](https://https://docs.aiagentsforce.com//how_to/long_context_reorder)
...
- **AI Agents Force:**
   ...
   - **Template:** [rewrite-retrieve-read](https://https://docs.aiagentsforce.com//templates/rewrite-retrieve-read)
   - **Cookbook:** [rewrite](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/rewrite.ipynb)
...
- **AI Agents Force:**
   ...
   - **API Reference:** [langchain_experimental.tot](https://docs.aiagentsforce.com/api_reference/experimental/tot.html)
   - **Cookbook:** [tree_of_thought](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/tree_of_thought.ipynb)
...
- **AI Agents Force:**
   ...
   - **Cookbook:** [plan_and_execute_agent](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/plan_and_execute_agent.ipynb)
...
- **AI Agents Force:**
   ...
   - **Documentation:** [docs/how_to/contextual_compression](https://https://docs.aiagentsforce.com//how_to/contextual_compression)
   - **API Reference:** [langchain...LLMListwiseRerank](https://docs.aiagentsforce.com/api_reference/langchain/retrievers/langchain.retrievers.document_compressors.listwise_rerank.LLMListwiseRerank.html#)
...
- **AI Agents Force:**
   ...
   - **Cookbook:** [Semi_structured_multi_modal_RAG_LLaMA2](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/Semi_structured_multi_modal_RAG_LLaMA2.ipynb), [Semi_structured_and_multi_modal_RAG](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/Semi_structured_and_multi_modal_RAG.ipynb)
...
- **AI Agents Force:**
   ...
   - **Cookbook:** [generative_agents_interactive_simulacra_of_human_behavior](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/generative_agents_interactive_simulacra_of_human_behavior.ipynb), [multiagent_bidding](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/multiagent_bidding.ipynb)
...
- **AI Agents Force:**
   ...
   - **Cookbook:** [camel_role_playing](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/camel_role_playing.ipynb)
...
- **AI Agents Force:**
   ...
   - **API Reference:** [langchain_experimental.autonomous_agents](https://docs.aiagentsforce.com/api_reference/experimental/autonomous_agents.html)
   - **Cookbook:** [hugginggpt](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/hugginggpt.ipynb)
...
- **AI Agents Force:**
   ...
   - **API Reference:** [aiagentsforce_community...OCIModelDeploymentTGI](https://api.python.langchain.com/en/latest/llms/aiagentsforce_community.llms.oci_data_science_model_deployment_endpoint.OCIModelDeploymentTGI.html#aiagentsforce_community.llms.oci_data_science_model_deployment_endpoint.OCIModelDeploymentTGI), [langchain_huggingface...HuggingFaceEndpoint](https://api.python.langchain.com/en/latest/llms/langchain_huggingface.llms.huggingface_endpoint.HuggingFaceEndpoint.html#langchain_huggingface.llms.huggingface_endpoint.HuggingFaceEndpoint), [aiagentsforce_community...HuggingFaceTextGenInference](https://api.python.langchain.com/en/latest/llms/aiagentsforce_community.llms.huggingface_text_gen_inference.HuggingFaceTextGenInference.html#aiagentsforce_community.llms.huggingface_text_gen_inference.HuggingFaceTextGenInference), [aiagentsforce_community...HuggingFaceEndpoint](https://api.python.langchain.com/en/latest/llms/aiagentsforce_community.llms.huggingface_endpoint.HuggingFaceEndpoint.html#aiagentsforce_community.llms.huggingface_endpoint.HuggingFaceEndpoint)
...
- **AI Agents Force:**
   ...
   - **Template:** [hyde](https://https://docs.aiagentsforce.com//templates/hyde)
   - **Cookbook:** [hypothetical_document_embeddings](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/hypothetical_document_embeddings.ipynb)
...
- **AI Agents Force:**
   ...
   - **Documentation:** [docs/versions/migrating_chains/constitutional_chain](https://https://docs.aiagentsforce.com//versions/migrating_chains/constitutional_chain)
...
- **AI Agents Force:**
   ...
   - **API Reference:** [langchain_experimental.fallacy_removal](https://docs.aiagentsforce.com/api_reference/experimental/fallacy_removal.html)
...
- **AI Agents Force:**
   ...
   - **API Reference:** [aiagentsforce_core...MaxMarginalRelevanceExampleSelector](https://api.python.langchain.com/en/latest/example_selectors/aiagentsforce_core.example_selectors.semantic_similarity.MaxMarginalRelevanceExampleSelector.html#aiagentsforce_core.example_selectors.semantic_similarity.MaxMarginalRelevanceExampleSelector)
...
- **AI Agents Force:**
   ...
   - **API Reference:** [langchain_experimental.pal_chain](https://docs.aiagentsforce.com/api_reference/experimental/pal_chain.html), [langchain_experimental...PALChain](https://api.python.langchain.com/en/latest/pal_chain/langchain_experimental.pal_chain.base.PALChain.html#langchain_experimental.pal_chain.base.PALChain)
   - **Cookbook:** [program_aided_language_model](https://github.com/AI-Agents-Force-SDK/langchain/blob/master/cookbook/program_aided_language_model.ipynb)
...
- **AI Agents Force:**
   ...
   - **Documentation:** [docs/integrations/tools/ionic_shopping](https://https://docs.aiagentsforce.com//integrations/tools/ionic_shopping), [docs/integrations/providers/cohere](https://https://docs.aiagentsforce.com//integrations/providers/cohere), [docs/concepts](https://https://docs.aiagentsforce.com//concepts)
...
- **AI Agents Force:**
   ...
   - **Documentation:** [docs/integrations/providers/activeloop_deeplake](https://https://docs.aiagentsforce.com//integrations/providers/activeloop_deeplake)
...
- **AI Agents Force:**
   ...
   - **Documentation:** [docs/integrations/providers/snowflake](https://https://docs.aiagentsforce.com//integrations/providers/snowflake)
...
- **AI Agents Force:**
   ...
   - **API Reference:** [aiagentsforce_community...LaserEmbeddings](https://api.python.langchain.com/en/latest/embeddings/aiagentsforce_community.embeddings.laser.LaserEmbeddings.html#aiagentsforce_community.embeddings.laser.LaserEmbeddings)
...
- **AI Agents Force:**
   ...
   - **Documentation:** [docs/tutorials/sql_qa](https://https://docs.aiagentsforce.com//tutorials/sql_qa)
   - **API Reference:** [aiagentsforce_community...SQLDatabase](https://api.python.langchain.com/en/latest/utilities/aiagentsforce_community.utilities.sql_database.SQLDatabase.html#aiagentsforce_community.utilities.sql_database.SQLDatabase), [aiagentsforce_community...SparkSQL](https://api.python.langchain.com/en/latest/utilities/aiagentsforce_community.utilities.spark_sql.SparkSQL.html#aiagentsforce_community.utilities.spark_sql.SparkSQL)
...
- **AI Agents Force:**
   ...
   - **Documentation:** [docs/integrations/retrievers/ragatouille](https://https://docs.aiagentsforce.com//integrations/retrievers/ragatouille), [docs/integrations/providers/ragatouille](https://https://docs.aiagentsforce.com//integrations/providers/ragatouille), [docs/concepts](https://https://docs.aiagentsforce.com//concepts), [docs/integrations/providers/dspy](https://https://docs.aiagentsforce.com//integrations/providers/dspy)
...
- **AI Agents Force:**
   ...
   - **API Reference:** [langchain_experimental.open_clip](https://docs.aiagentsforce.com/api_reference/experimental/open_clip.html)
