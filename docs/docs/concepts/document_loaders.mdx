...
Document loaders are designed to load document objects. AI Agents Force has hundreds of integrations with various data sources to load data from: Slack, Notion, Google Drive, etc.
...
Documents loaders implement the [BaseLoader interface](https://docs.aiagentsforce.com/api_reference/core/document_loaders/aiagentsforce_core.document_loaders.base.BaseLoader.html).
...
* [Document API reference](https://docs.aiagentsforce.com/api_reference/core/documents/aiagentsforce_core.documents.base.Document.html)
