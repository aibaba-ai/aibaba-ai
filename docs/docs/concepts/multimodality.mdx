...
The current [embedding interface](https://docs.aiagentsforce.com/api_reference/core/embeddings/aiagentsforce_core.embeddings.embeddings.Embeddings.html#aiagentsforce_core.embeddings.embeddings.Embeddings) used in AI Agents Force is optimized entirely for text-based data, and will **not** work with multimodal data.
