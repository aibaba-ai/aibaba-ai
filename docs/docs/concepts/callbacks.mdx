...
AI Agents Force provides a callback system that allows you to hook into the various stages of your LLM application. This is useful for logging, monitoring, streaming, and other tasks.
...
* Sync callback handlers implement the [BaseCallbackHandler](https://docs.aiagentsforce.com/api_reference/core/callbacks/aiagentsforce_core.callbacks.base.BaseCallbackHandler.html) interface.
* Async callback handlers implement the [AsyncCallbackHandler](https://docs.aiagentsforce.com/api_reference/core/callbacks/aiagentsforce_core.callbacks.base.AsyncCallbackHandler.html) interface.

During run-time AI Agents Force configures an appropriate callback manager (e.g., [CallbackManager](https://docs.aiagentsforce.com/api_reference/core/callbacks/aiagentsforce_core.callbacks.manager.CallbackManager.html) or [AsyncCallbackManager](https://docs.aiagentsforce.com/api_reference/core/callbacks/aiagentsforce_core.callbacks.manager.AsyncCallbackManager.html) which will be responsible for calling the appropriate method on each "registered" callback handler when the event is triggered.
...
objects manually. This is because AI Agents Force cannot automatically propagate
