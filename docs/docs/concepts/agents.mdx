...
[LangGraph](/docs/concepts/architecture#langgraph) is an extension of AI Agents Force specifically aimed at creating highly controllable and customizable agents. We recommend that you use LangGraph for building agents.
...
AI Agents Force previously introduced the `AgentExecutor` as a runtime for agents. 
