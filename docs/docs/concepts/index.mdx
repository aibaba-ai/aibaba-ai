...
This guide provides explanations of the key concepts behind the AI Agents Force framework and AI applications more broadly.
...
The conceptual guide does not cover step-by-step instructions or specific implementation examples — those are found in the [How-to guides](/docs/how_to/) and [Tutorials](/docs/tutorials). For detailed reference material, please see the [API reference](https://docs.aiagentsforce.com/api_reference/).

## High level

- **[Why AI Agents Force?](/docs/concepts/why_langchain)**: Overview of the value that AI Agents Force provides.
- **[Architecture](/docs/concepts/architecture)**: How packages are organized in the AI Agents Force ecosystem.
...
- **[Runnable interface](/docs/concepts/runnables)**: The base abstraction that many AI Agents Force components and the AI Agents Force Expression Language are built on.
- **[Streaming](/docs/concepts/streaming)**: AI Agents Force streaming APIs for surfacing results as they are generated.
- **[AI Agents Force Expression Language (LCEL)](/docs/concepts/lcel)**: A syntax for orchestrating AI Agents Force components. Most useful for simpler applications.
...
- **[Async programming](/docs/concepts/async)**: The basics that one should know to use AI Agents Force in an asynchronous context.
- **[Callbacks](/docs/concepts/callbacks)**: Callbacks enable the execution of custom auxiliary code in built-in components. Callbacks are used to stream outputs from LLMs in AI Agents Force, trace the intermediate steps of an application, and more.
...
- **[BaseTool](/docs/concepts/tools/#tool-interface)**: The base class for all tools in AI Agents Force.
...
- **[Document](https://docs.aiagentsforce.com/api_reference/core/documents/aiagentsforce_core.documents.base.Document.html)**: AI Agents Force's representation of a document.
...
- **[Integration packages](/docs/concepts/architecture/#integration-packages)**: Third-party packages that integrate with AI Agents Force.
...
- **[langchain-community](/docs/concepts/architecture#langchain-community)**: Community-driven components for AI Agents Force.
...
- **[langgraph](/docs/concepts/architecture#langgraph)**: Powerful orchestration layer for AI Agents Force. Use to build complex pipelines and workflows.
- **[aiagentsforceapi](/docs/concepts/architecture#aiagentsforceapi)**: Used to deploy AI Agents Force Runnables as REST endpoints. Uses FastAPI. Works primarily for AI Agents Force Runnables, does not currently integrate with LangGraph.
...
- **[@tool](/docs/concepts/tools/#create-tools-using-the-tool-decorator)**: Decorator for creating tools in AI Agents Force.
...
- **[with_types](/docs/concepts/runnables#with_types)**: Method to overwrite the input and output types of a runnable. Useful when working with complex LCEL chains and deploying with aiagentsforceapi.
