...
Example implementation using AI Agents Force's `CharacterTextSplitter` with token-based splitting:
...
AI Agents Force's [`RecursiveCharacterTextSplitter`](/docs/how_to/recursive_text_splitter/) implements this concept:
