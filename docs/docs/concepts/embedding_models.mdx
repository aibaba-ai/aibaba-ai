...
* [Documents](https://docs.aiagentsforce.com/api_reference/core/documents/aiagentsforce_core.documents.base.Document.html)
...
Embedding models can also be [multimodal](/docs/concepts/multimodality) though such models are not currently supported by AI Agents Force.
:::
...
AI Agents Force provides a universal interface for working with them, providing standard methods for common operations.
...
To illustrate, here's a practical example using AI Agents Force's `.embed_documents` method to embed a list of strings:
...
* See the full list of [AI Agents Force embedding model integrations](/docs/integrations/text_embedding/).
...
AI Agents Force offers many embedding model integrations which you can find [on the embedding models](/docs/integrations/text_embedding/) integrations page.
