...
**(1) Tool Creation:** Use the [@tool](https://docs.aiagentsforce.com/api_reference/core/tools/aiagentsforce_core.tools.convert.tool.html) decorator to create a [tool](/docs/concepts/tools). A tool is an association between a function and its schema.
...
The central concept to understand is that AI Agents Force provides a standardized interface for connecting tools to models. 
