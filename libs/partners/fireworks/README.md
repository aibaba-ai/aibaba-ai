# AI Agents Force-Fireworks

This is the partner package for tying Fireworks.ai and AI Agents Force. Fireworks really strive to provide good support for AI Agents Force use cases, so if you run into any issues please let us know. You can reach out to us [in our Discord channel](https://discord.com/channels/1137072072808472616/)
...
## Advanced usage
### Tool use: AI Agents Force Agent + Fireworks function calling model
...
### RAG: AI Agents Force agent + Fireworks function calling model + MongoDB + Nomic AI embeddings
