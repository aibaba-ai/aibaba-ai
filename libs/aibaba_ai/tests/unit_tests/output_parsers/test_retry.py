...
import pytest
from aibaba_ai_core.prompt_values import PromptValue, StringPromptValue
from aibaba_ai_core.runnables import Runnable, RunnableLambda, RunnablePassthrough
