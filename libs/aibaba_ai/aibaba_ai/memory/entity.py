"""Deprecated as of Aibaba AI v0.3.4 and will be removed in Aibaba AI v1.0.0."""
...
from aibaba_ai_core.messages import BaseMessage, get_buffer_string
...
@deprecated(
    ...
    message=(
        ...
        "https://docs.aibaba.world/docs/versions/migrating_memory/"
    ),
)
