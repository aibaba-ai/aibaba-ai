...
@deprecated(
    ...
    alternative=(
        ...
        "https://docs.aibaba.world/v0.2/api_reference/core/runnables/aibaba_ai_core.runnables.history.RunnableWithMessageHistory.html"  # noqa: E501
    ),
    removal="1.0",
)
class ConversationChain(LLMChain):  # type: ignore[override, override]
    ...
    to this tutorial for more detail: https://docs.aibaba.world/docs/tutorials/chatbot/
