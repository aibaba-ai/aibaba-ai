...
from aibaba_ai_core.language_models import LanguageModelLike
from aibaba_ai_core.output_parsers import BaseOutputParser, StrOutputParser
...
@deprecated(
    ...
    message=(
        ...
        "https://docs.aibaba.world/docs/versions/migrating_chains/stuff_docs_chain/"  # noqa: E501
    ),
)
