...
from aibaba_ai_core.runnables import Runnable, RunnableConfig, ensure_config
from aibaba_ai_core.runnables.schema import StreamEvent
from aibaba_ai_core.tools import BaseTool
from aibaba_ai_core.tracers import RunLog, RunLogPatch
...
class _ConfigurableModel(Runnable[LanguageModelInput, Any]):
    ...
    def InputType(self) -> TypeAlias:
        ...
        from aibaba_ai_core.prompt_values import (
