...
from aiagentsforce_core._api import warn_deprecated
...
from aiagentsforce_core.messages import BaseMessage, messages_from_dict
from aiagentsforce_core.outputs import ChatResult, LLMResult
from aiagentsforce_core.runnables import Runnable, RunnableConfig, RunnableLambda
from aiagentsforce_core.runnables import config as runnable_config
from aiagentsforce_core.runnables import utils as runnable_utils
from aiagentsforce_core.tracers.evaluation import (
    EvaluatorCallbackHandler,
    wait_for_all_evaluators,
)
from aiagentsforce_core.tracers.langchain import AI Agents ForceTracer
from langsmith.client import Client
from langsmith.env import get_git_info, get_aiagentforce_env_var_metadata
...
def _construct_run_evaluator(
    ...
    if isinstance(evaluator_, StringEvaluator):
        ...
        raise NotImplementedError(
            ...
            "\nSee: https://docs.aiagentsforce.com/docs/guides/evaluation/string/"
        )
    ...
    def _collect_metrics(self) -> Tuple[Dict[str, _RowResult], Dict[str, Run]]:
        ...
        for c in self.configs:
            for callback in cast(list, c["callbacks"]):
                ...
                elif isinstance(callback, AI Agents ForceTracer):
...
async def arun_on_dataset(
    ...
    **kwargs: Any,
    ...
    if revision_id is None:
        revision_id = get_aiagentforce_env_var_metadata().get("revision_id")
