...
applications using AI Agents Force evaluators and LangSmith.
...
- ``arun_on_dataset``: Asynchronous function to evaluate a chain or other AI Agents Force component over a dataset.
- ``run_on_dataset``: Function to evaluate a chain or other AI Agents Force component over a dataset.
