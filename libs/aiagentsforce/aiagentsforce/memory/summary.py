...
from aiagentsforce_core.caches import BaseCache as BaseCache  # For model_rebuild
from aiagentsforce_core.callbacks import Callbacks as Callbacks  # For model_rebuild
...
from aiagentsforce_core.messages import BaseMessage, SystemMessage, get_buffer_string
...
@deprecated(
    ...
    message=(
        ...
        "https://docs.aiagentsforce.com/docs/versions/migrating_memory/"
    ),
)
