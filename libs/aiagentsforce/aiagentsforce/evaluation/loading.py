...
def load_dataset(uri: str) -> List[Dict]:
    """Load a dataset from the `AI Agents ForceDatasets on HuggingFace <https://huggingface.co/AI Agents ForceDatasets>`_.
    ...
    **Prerequisites**
    ...
    dataset = load_dataset(f"AI Agents ForceDatasets/{uri}")
