...
from aiagentsforce_core._api.deprecation import surface_aiagentforce_deprecation_warnings
...
def __getattr__(name: str) -> Any:
    if name == "MRKLChain":
        ...
        raise ImportError(
            ...
            "For more details: "
            "https://github.com/AI-Agents-Force-SDK/langchain/discussions/11352."
        ...
        _warn_on_import(
            name, replacement="aiagentsforce_core.prompts.FewShotPromptTemplate"
        )
        ...
        _warn_on_import(name, replacement="aiagentsforce_core.prompts.PromptTemplate")
        ...
        _warn_on_import(name, replacement="aiagentsforce_core.prompts.BasePromptTemplate")
