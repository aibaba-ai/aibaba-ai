...
from aiagentsforce_core.callbacks import BaseCallbackManager, Callbacks
from aiagentsforce_core.language_models import BaseLanguageModel
from aiagentsforce_core.prompts import BasePromptTemplate
...
@deprecated(
    ...
    message=(
        ...
        "based on `chain_type`:\n"
        "stuff: https://docs.aiagentsforce.com/docs/versions/migrating_chains/stuff_docs_chain\n"  # noqa: E501
        "map_reduce: https://docs.aiagentsforce.com/docs/versions/migrating_chains/map_reduce_chain\n"  # noqa: E501
        "refine: https://docs.aiagentsforce.com/docs/versions/migrating_chains/refine_chain\n"  # noqa: E501
        "map_rerank: https://docs.aiagentsforce.com/docs/versions/migrating_chains/map_rerank_docs_chain\n"  # noqa: E501
        "\nSee also guides on retrieval and question-answering here: "
        "https://docs.aiagentsforce.com/docs/how_to/#qa-with-rag"
    ),
)
def load_qa_chain(
    llm: BaseLanguageModel,
