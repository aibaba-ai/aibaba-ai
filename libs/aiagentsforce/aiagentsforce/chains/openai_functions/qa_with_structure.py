...
from aiagentsforce_core.output_parsers import BaseLLMOutputParser
...
@deprecated(
    ...
    message=(
        ...
        "https://docs.aiagentsforce.com/docs/how_to/qa_sources/#structure-sources-in-model-response"  # noqa: E501
    ),
)
