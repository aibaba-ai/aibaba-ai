...
from aiagentsforce_core.output_parsers.openai_functions import (
    JsonKeyOutputFunctionsParser,
    PydanticAttrOutputFunctionsParser,
)
from aiagentsforce_core.prompts import BasePromptTemplate, ChatPromptTemplate
...
@deprecated(
    since="0.1.14",
    message=(
        "AI Agents Force has introduced a method called `with_structured_output` that"
        "is available on ChatModels capable of tool calling."
        "You can read more about the method here: "
        "<https://docs.aiagentsforce.com/docs/modules/model_io/chat/structured_output/>. "
        "Please follow our extraction use case documentation for more guidelines"
        "on how to do information extraction with LLMs."
        "<https://docs.aiagentsforce.com/docs/use_cases/extraction/>. "
        "If you notice other issues, please provide "
        "feedback here:"
        "<https://github.com/AI-Agents-Force-SDK/langchain/discussions/18154>"
    ),
    removal="1.0",
    alternative=(
        """
