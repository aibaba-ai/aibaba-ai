...
from aiagentsforce_core.language_models import LanguageModelLike
from aiagentsforce_core.output_parsers import BaseOutputParser, StrOutputParser
...
@deprecated(
    ...
    message=(
        ...
        "https://docs.aiagentsforce.com/docs/versions/migrating_chains/stuff_docs_chain/"  # noqa: E501
    ),
)
