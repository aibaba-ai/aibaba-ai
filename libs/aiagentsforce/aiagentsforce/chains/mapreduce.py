...
from aiagentsforce_core.callbacks import CallbackManagerForChainRun, Callbacks
...
@deprecated(
    ...
    message=(
        ...
        "LangGraph: https://docs.aiagentsforce.com/docs/versions/migrating_chains/map_reduce_chain/"  # noqa: E501
