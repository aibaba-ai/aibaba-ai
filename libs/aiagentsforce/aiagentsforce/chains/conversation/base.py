...
@deprecated(
    ...
    alternative=(
        ...
        "https://docs.aiagentsforce.com/v0.2/api_reference/core/runnables/aiagentsforce_core.runnables.history.RunnableWithMessageHistory.html"  # noqa: E501
    ),
    removal="1.0",
)
class ConversationChain(LLMChain):  # type: ignore[override, override]
    ...
    to this tutorial for more detail: https://docs.aiagentsforce.com/docs/tutorials/chatbot/
