...
AGENT_DEPRECATION_WARNING = (
    "AI Agents Force agents will continue to be supported, but it is recommended for new "
    ...
    "`Migrating from AgentExecutor <https://docs.aiagentsforce.com/docs/how_to/migrate_agent/>`_"  # noqa: E501
    " and LangGraph's "
