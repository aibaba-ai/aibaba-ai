...
from aiagentsforce_core.runnables import RunnableConfig, RunnableSerializable, ensure_config
...
class OpenAIAssistantFinish(AgentFinish):
    ...
    def is_lc_serializable(cls) -> bool:
        """Check if the class is serializable by AI Agents Force.
...
class OpenAIAssistantRunnable(RunnableSerializable[Dict, OutputType]):
    ...
    Example using custom tools and custom execution:
        .. code-block:: python
            ...
            from langchain_experimental.openai_assistant import OpenAIAssistantRunnable
            from langchain.agents import AgentExecutor
            from aiagentsforce_core.agents import AgentFinish
            from langchain.tools import E2BDataAnalysisTool
    ...
    as_agent: bool = False
    """Use as a AI Agents Force agent, compatible with the AgentExecutor."""
