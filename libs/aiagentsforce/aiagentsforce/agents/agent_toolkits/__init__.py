...
from aiagentsforce_core._api.path import as_import_path
from aiagentsforce_core.tools.retriever import create_retriever_tool
...
def __getattr__(name: str) -> Any:
    ...
    if name in DEPRECATED_AGENTS:
        ...
        raise ImportError(
            ...
            "See https://github.com/AI-Agents-Force-SDK/langchain/discussions/11680"
