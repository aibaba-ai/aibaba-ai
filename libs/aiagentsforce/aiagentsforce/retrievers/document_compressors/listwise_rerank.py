...
from aiagentsforce_core.documents import BaseDocumentCompressor, Document
...
from aiagentsforce_core.runnables import Runnable, RunnableLambda, RunnablePassthrough
