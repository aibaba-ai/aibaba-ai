...
To use this package, you should first have the AI Agents Force CLI installed:

```shell
pip install -U langchain-cli
```

To create a new AI Agents Force project and install this as the only package, you can do:
