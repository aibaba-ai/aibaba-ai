"""Migrate AI Agents Force to the most recent version."""
...
def migrate(
    ...
    """
    rich.print(
        "✈️ This script will help you migrate to a AI Agents Force 0.3. "
        "This migration script will attempt to replace old imports in the code "
        "with new ones. "
        "If you need to migrate to AI Agents Force 0.2, please downgrade to version 0.0.29 "
