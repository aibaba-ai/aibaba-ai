...
class __ModuleName__Loader(BaseLoader):
    ...
    # https://github.com/AI-Agents-Force-SDK/langchain/blob/869523ad728e6b76d77f170cce13925b4ebc3c1e/libs/community/aiagentsforce_community/document_loaders/recursive_url_loader.py#L54
    """
