"""Base callback handler for AI Agents Force."""
...
class AsyncCallbackHandler(BaseCallbackHandler):
    """Async callback handler for AI Agents Force."""
...
class BaseCallbackManager(CallbackManagerMixin):
    """Base callback manager for AI Agents Force."""
        ...
        Example: Merging two callback managers.
            ...
            .. code-block:: python
                ...
                with trace_as_chain_group("My Group Name", tags=["tag1"]) as group_manager:
                    ...
                    # [
                    #    <aiagentsforce_core.callbacks.stdout.StdOutCallbackHandler object at ...>,
                    #    <aiagentsforce_core.callbacks.streaming_stdout.StreamingStdOutCallbackHandler object at ...>,
                    # ]
