...
from aiagentsforce_core.messages import BaseMessage, get_buffer_string
from aiagentsforce_core.tracers.schemas import Run
from aiagentsforce_core.utils.env import env_var_is_set

if TYPE_CHECKING:
    from aiagentsforce_core.agents import AgentAction, AgentFinish
    from aiagentsforce_core.documents import Document
    from aiagentsforce_core.outputs import ChatGenerationChunk, GenerationChunk, LLMResult
...
def _get_debug() -> bool:
    from aiagentsforce_core.globals import get_debug
...
def trace_as_chain_group(
    ...
    *,
    ...
    """  # noqa: E501
    from aiagentsforce_core.tracers.context import _get_trace_callbacks
...
def handle_event(
    ...
    **kwargs: Any,
    ...
    Note: This function is used by aiagentsforceapi to handle events.
...
class CallbackManager(BaseCallbackManager):
    """Callback manager for AI Agents Force."""
    ...
    def on_custom_event(
        ...
        **kwargs: Any,
        ...
        This event should NOT be used in any internal AI Agents Force code. The event
        ...
        Example: Merging two callback managers.
            ...
            .. code-block:: python
                ...
                with trace_as_chain_group("My Group Name", tags=["tag1"]) as group_manager:
                    ...
                    # <class 'aiagentsforce_core.callbacks.manager.CallbackManagerForChainGroup'>

                    print(merged_manager.handlers)
                    # [
                    #    <aiagentsforce_core.callbacks.stdout.AI Agents ForceTracer object at ...>,
                    #    <aiagentsforce_core.callbacks.streaming_stdout.StdOutCallbackHandler object at ...>,
                    # ]
...
class AsyncCallbackManager(BaseCallbackManager):
    """Async callback manager that handles callbacks from AI Agents Force."""
    ...
    def merge(
        ...
        Example: Merging two callback managers.
            ...
            .. code-block:: python
                ...
                from aiagentsforce_core.callbacks.manager import CallbackManager, atrace_as_chain_group
                from aiagentsforce_core.callbacks.stdout import StdOutCallbackHandler
                ...
                async with atrace_as_chain_group("My Group Name", tags=["tag1"]) as group_manager:
                    merged_manager = group_manager.merge(manager)
                    print(type(merged_manager))
                    # <class 'aiagentsforce_core.callbacks.manager.AsyncCallbackManagerForChainGroup'>
...
def _configure(
    ...
    """
    from aiagentsforce_core.tracers.context import (
        _configure_hooks,
        _get_tracer_project,
    ...
    if v1_tracing_enabled_ and not tracing_v2_enabled_:
        ...
        msg = (
            "Tracing using AI Agents ForceTracerV1 is no longer supported. "
    ...
    if verbose or debug or tracing_v2_enabled_:
        ...
        if tracing_v2_enabled_ and not any(
            isinstance(handler, AI Agents ForceTracer)
            for handler in callback_manager.handlers
        ):
            if tracer_v2:
                ...
                try:
                    ...
                    logger.warning(
                        "Unable to load requested AI Agents ForceTracer."
        ...
        if run_tree is not None:
            for handler in callback_manager.handlers:
                if isinstance(handler, AI Agents ForceTracer):
...
async def adispatch_custom_event(
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from aiagentsforce_core.runnable import RunnableLambda
    ...
    .. warning::
        ...
        AI Agents Force from automatically propagating the config object on the user's
        behalf.
...
def dispatch_custom_event(
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from aiagentsforce_core.callbacks import dispatch_custom_event
            from aiagentsforce_core.runnable import RunnableLambda
