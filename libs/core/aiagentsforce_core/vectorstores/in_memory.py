...
from aiagentsforce_core.vectorstores.utils import _cosine_similarity as cosine_similarity
from aiagentsforce_core.vectorstores.utils import maximal_marginal_relevance

if TYPE_CHECKING:
    from aiagentsforce_core.indexing import UpsertResponse
