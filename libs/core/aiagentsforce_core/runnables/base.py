...
from aiagentsforce_core._api import beta_decorator
from aiagentsforce_core.load.serializable import (
    Serializable,
...
from aiagentsforce_core.runnables.graph import Graph
...
from aiagentsforce_core.utils.aiter import aclosing, atee, py_anext
from aiagentsforce_core.utils.iter import safetee
from aiagentsforce_core.utils.pydantic import create_model_v2
...
if TYPE_CHECKING:
    ...
    from aiagentsforce_core.prompts.base import BasePromptTemplate
    from aiagentsforce_core.runnables.fallbacks import (
...
class Runnable(Generic[Input, Output], ABC):
    ...
    The AI Agents Force Expression Language (LCEL) is a declarative way to compose Runnables
    ...
    **RunnableParallel** invokes runnables concurrently, providing the same input
    ...
    You can set the global debug flag to True to enable debug output for all chains:
        ...
        .. code-block:: python
            ...
            from aiagentsforce_core.globals import set_debug
            set_debug(True)
    ...
    Alternatively, you can pass existing or custom callbacks to any given chain:
        ...
        .. code-block:: python
            ...
            from aiagentsforce_core.tracers import ConsoleCallbackHandler
    ...
    def pick(self, keys: Union[str, list[str]]) -> RunnableSerializable[Any, Any]:
        ...
        Pick single key:
            .. code-block:: python
                ...
                from aiagentsforce_core.runnables import RunnableLambda, RunnableMap
        ...
        """
        from aiagentsforce_core.runnables.passthrough import RunnablePick
    ...
    def assign(
        ...
        **kwargs: Union[
        ...
        .. code-block:: python
            ...
            from aiagentsforce_core.prompts import SystemMessagePromptTemplate
        ...
        """
        from aiagentsforce_core.runnables.passthrough import RunnableAssign
    ...
    async def astream_events(
        ...
        **ATTENTION** This reference table is for the V2 version of the schema.
        ...
        .. code-block:: python
            ...
            from aiagentsforce_core.runnables import RunnableLambda, RunnableConfig
            import asyncio
        ...
        """  # noqa: E501
        from aiagentsforce_core.tracers.event_stream import (
    ...
    def with_retry(
        ...
        *,
        ...
        Returns:
            A new Runnable that retries the original Runnable on exceptions.
        """
        from aiagentsforce_core.runnables.retry import RunnableRetry
        ...
        *,
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from aiagentsforce_core.runnables import RunnableGenerator
    ...
    def _transform_stream_with_config(
        ...
        **kwargs: Optional[Any],
        ...
        from aiagentsforce_core.tracers._streaming import _StreamingCallbackHandler
    ...
    def as_tool(
        ...
        *,
        ...
        from aiagentsforce_core.tools import convert_runnable_to_tool
...
class RunnableSerializable(Serializable, Runnable[Input, Output]):
    ...
    def configurable_fields(
        ...
        """
        from aiagentsforce_core.runnables.configurable import RunnableConfigurableFields
    ...
    def configurable_alternatives(
        ...
        **kwargs: Union[Runnable[Input, Output], Callable[[], Runnable[Input, Output]]],
        ...
        .. code-block:: python
            ...
            from aiagentsforce_core.runnables.utils import ConfigurableField
            from langchain_openai import ChatOpenAI
        ...
        """
        from aiagentsforce_core.runnables.configurable import (
...
def _seq_input_schema(
    ...
    from aiagentsforce_core.runnables.passthrough import RunnableAssign, RunnablePick
...
class RunnableSequence(RunnableSerializable[Input, Output]):
    ...
    **RunnableSequence** is the most important composition operator in AI Agents Force
    ...
    Here's an example that uses streams JSON output generated by an LLM:
        ...
        .. code-block:: python
            ...
            from aiagentsforce_core.output_parsers.json import SimpleJsonOutputParser
            from langchain_openai import ChatOpenAI
    ...
    def config_specs(self) -> list[ConfigurableFieldSpec]:
        ...
        """
        from aiagentsforce_core.beta.runnables.context import (
    ...
    def invoke(
        ...
        from aiagentsforce_core.beta.runnables.context import config_with_context
    ...
    async def ainvoke(
        ...
        **kwargs: Optional[Any],
        ...
        from aiagentsforce_core.beta.runnables.context import aconfig_with_context
    ...
    async def abatch(
        ...
        **kwargs: Optional[Any],
        ...
        from aiagentsforce_core.beta.runnables.context import aconfig_with_context
        from aiagentsforce_core.callbacks.manager import AsyncCallbackManager
...
class RunnableParallel(RunnableSerializable[Input, dict[str, Any]]):
    ...
    we simultaneously stream output from two different Runnables:
        ...
        .. code-block:: python
            ...
            from aiagentsforce_core.runnables import RunnableParallel
            from langchain_openai import ChatOpenAI
...
class RunnableGenerator(Runnable[Input, Output]):
    ...
    context. Below we show an example:
        ...
        .. code-block:: python
            ...
            from aiagentsforce_core.prompts import ChatPromptTemplate
            from aiagentsforce_core.runnables import RunnableGenerator, RunnableLambda
            from langchain_openai import ChatOpenAI
            from aiagentsforce_core.output_parsers import StrOutputParser
...
class RunnableLambda(Runnable[Input, Output]):
    ...
    seamless integration with AI Agents Force tracing.
...
class RunnableEach(RunnableEachBase[Input, Output]):
    ...
    with a Runnable:
        ...
        .. code-block:: python
            ...
            from aiagentsforce_core.runnables.base import RunnableEach
            from langchain_openai import ChatOpenAI
            from aiagentsforce_core.prompts import ChatPromptTemplate
            from aiagentsforce_core.output_parsers import StrOutputParser
...
def chain(
    ...
    .. code-block:: python
        ...
        from aiagentsforce_core.runnables import chain
