...
from aiagentsforce_core.load.load import load
from aiagentsforce_core.runnables.base import Runnable, RunnableBindingBase, RunnableLambda
...
if TYPE_CHECKING:
    from aiagentsforce_core.language_models.base import LanguageModelLike
...
class RunnableWithMessageHistory(RunnableBindingBase):
    ...
    .. code-block:: python
        ...
        from aiagentsforce_core.messages import BaseMessage, AIMessage
