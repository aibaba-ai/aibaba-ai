...
from aiagentsforce_core.utils.aiter import py_anext

if TYPE_CHECKING:
    from aiagentsforce_core.callbacks.manager import AsyncCallbackManagerForChainRun
...
class RunnableWithFallbacks(RunnableSerializable[Input, Output]):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from aiagentsforce_core.chat_models.openai import ChatOpenAI
            from aiagentsforce_core.chat_models.anthropic import ChatAnthropic
            ...
            from aiagentsforce_core.output_parser import StrOutputParser
