...
from aiagentsforce_core.exceptions import ErrorCode, create_message
from aiagentsforce_core.messages.ai import AIMessage, AIMessageChunk
from aiagentsforce_core.messages.base import BaseMessage, BaseMessageChunk
from aiagentsforce_core.messages.chat import ChatMessage, ChatMessageChunk
from aiagentsforce_core.messages.function import FunctionMessage, FunctionMessageChunk
from aiagentsforce_core.messages.human import HumanMessage, HumanMessageChunk
from aiagentsforce_core.messages.modifier import RemoveMessage
from aiagentsforce_core.messages.system import SystemMessage, SystemMessageChunk
from aiagentsforce_core.messages.tool import ToolCall, ToolMessage, ToolMessageChunk
...
if TYPE_CHECKING:
    ...
    from aiagentsforce_core.runnables.base import Runnable
...
def get_buffer_string(
    ...
    Example:
        .. code-block:: python
            ...
            from aiagentsforce_core import AIMessage, HumanMessage
    ...
    **additional_kwargs: Any,
    ...
    if tool_calls is not None:
        ...
        for tool_call in tool_calls:
            # Convert OpenAI-format tool call to AI Agents Force format.
    ...
    *,
    ...
    Example:
        .. code-block:: python
            ...
            from aiagentsforce_core.messages import filter_messages, AIMessage, HumanMessage, SystemMessage
...
def trim_messages(
    ...
    *,
    ...
    1. The resulting chat history should be valid. Most chat models expect that chat
       ...
       https://docs.aiagentsforce.com/docs/concepts/#messages
...
def convert_to_openai_messages(
    ...
    *,
    ...
    """Convert AI Agents Force messages into OpenAI message dicts.
