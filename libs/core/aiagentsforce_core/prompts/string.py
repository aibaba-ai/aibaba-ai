...
import aiagentsforce_core.utils.mustache as mustache
from aiagentsforce_core.prompt_values import PromptValue, StringPromptValue
from aiagentsforce_core.prompts.base import BasePromptTemplate
from aiagentsforce_core.utils import get_colored_text
from aiagentsforce_core.utils.formatting import formatter
...
def jinja2_formatter(template: str, /, **kwargs: Any) -> str:
    ...
    *Security warning*:
        As of AI Agents Force 0.0.329, this method uses Jinja2's
