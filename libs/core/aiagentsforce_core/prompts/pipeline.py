...
from aiagentsforce_core.prompts.chat import BaseChatPromptTemplate
...
@deprecated(
    ...
    message=(
        ...
        "https://docs.aiagentsforce.com/api_reference/core/prompts/aiagentsforce_core.prompts.pipeline.PipelinePromptTemplate.html"
    ),
)
