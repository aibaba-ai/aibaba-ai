...
from aiagentsforce_core.prompts.chat import ChatPromptTemplate
...
def _load_prompt(config: dict) -> PromptTemplate:
    ...
    if template_format == "jinja2":
        # Disabled due to:
        # https://github.com/AI-Agents-Force-SDK/langchain/issues/4394
        msg = (
...
def load_prompt(
    ...
    """Unified method for loading a prompt from AI Agents ForceHub or local fs.
    ...
    if isinstance(path, str) and path.startswith("lc://"):
        msg = (
            ...
            "Please use the new AI Agents Force Hub at https://smith.langchain.com/hub "
            "instead."
        )
