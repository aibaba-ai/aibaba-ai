"""Helper functions for marking parts of the AI Agents Force API as beta.
...
class AI Agents ForceBetaWarning(DeprecationWarning):
    """A class for issuing beta warnings for AI Agents Force users."""
...
def suppress_aiagentforce_beta_warning() -> Generator[None, None, None]:
    """Context manager to suppress AI Agents ForceDeprecationWarning."""
    with warnings.catch_warnings():
        warnings.simplefilter("ignore", AI Agents ForceBetaWarning)
        yield
...
def warn_beta(
    *,
    ...
    warning = AI Agents ForceBetaWarning(message)
    warnings.warn(warning, category=AI Agents ForceBetaWarning, stacklevel=4)


def surface_aiagentforce_beta_warnings() -> None:
    """Unmute AI Agents Force beta warnings."""
    warnings.filterwarnings(
        "default",
        category=AI Agents ForceBetaWarning,
    )
