"""Helper functions for deprecating parts of the AI Agents Force API.
...
from aiagentsforce_core._api.internal import is_caller_internal


class AI Agents ForceDeprecationWarning(DeprecationWarning):
    """A class for issuing deprecation warnings for AI Agents Force users."""


class AI Agents ForcePendingDeprecationWarning(PendingDeprecationWarning):
    """A class for issuing deprecation warnings for AI Agents Force users."""
    ...
    *,
    ...
    def deprecate(
        ...
        *,
        ...
        from aiagentsforce_core.utils.pydantic import FieldInfoV1, FieldInfoV2
...
def suppress_aiagentforce_deprecation_warning() -> Generator[None, None, None]:
    """Context manager to suppress AI Agents ForceDeprecationWarning."""
    with warnings.catch_warnings():
        warnings.simplefilter("ignore", AI Agents ForceDeprecationWarning)
        warnings.simplefilter("ignore", AI Agents ForcePendingDeprecationWarning)
        yield
...
def warn_deprecated(
    ...
    *,
    ...
    warning_cls = (
        AI Agents ForcePendingDeprecationWarning if pending else AI Agents ForceDeprecationWarning
    )
    warning = warning_cls(message)
    warnings.warn(warning, category=AI Agents ForceDeprecationWarning, stacklevel=4)


def surface_aiagentforce_deprecation_warnings() -> None:
    """Unmute AI Agents Force deprecation warnings."""
    warnings.filterwarnings(
        "default",
        category=AI Agents ForcePendingDeprecationWarning,
    )
