...
from aiagentsforce_core.messages.tool import ToolCall, ToolMessage, ToolOutputMixin
...
from aiagentsforce_core.runnables.config import _set_config_context
from aiagentsforce_core.runnables.utils import asyncio_accepts_context
...
class BaseTool(RunnableSerializable[Union[str, dict, ToolCall], Any]):
    """Interface AI Agents Force tools must implement."""
...
class InjectedToolCallId(InjectedToolArg):
    ...
    Example:
        ..code-block:: python
            ...
            from aiagentsforce_core.tools import tool, InjectedToolCallID
