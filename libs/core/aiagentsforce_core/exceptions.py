"""Custom **exceptions** for AI Agents Force."""

from enum import Enum
from typing import Any, Optional


class AI Agents ForceException(Exception):  # noqa: N818
    """General AI Agents Force exception."""


class TracerException(AI Agents ForceException):
    """Base class for exceptions in tracers module."""


class OutputParserException(ValueError, AI Agents ForceException):  # noqa: N818
...
def create_message(*, message: str, error_code: ErrorCode) -> str:
    return (
        f"{message}\n"
        "For troubleshooting, visit: https://docs.aiagentsforce.com/docs/"
