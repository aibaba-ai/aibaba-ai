...
from aiagentsforce_core.utils.json_schema import dereference_refs
...
convert_pydantic_to_openai_function = deprecated(
    "0.1.16",
    alternative="aiagentsforce_core.utils.function_calling.convert_to_openai_function()",
    removal="1.0",
...
@deprecated(
    "0.1.16",
    alternative="aiagentsforce_core.utils.function_calling.convert_to_openai_tool()",
    removal="1.0",
)
...
def _convert_python_function_to_openai_function(
    ...
    """
    from aiagentsforce_core.tools.base import create_schema_from_function
...
def _format_tool_to_openai_function(tool: BaseTool) -> FunctionDescription:
    ...
    Returns:
        The function description.
    """
    from aiagentsforce_core.tools import simple
...
def convert_to_openai_function(
    ...
    *,
    ...
    Args:
        function:
            A dictionary, Pydantic BaseModel class, TypedDict class, a AI Agents Force
