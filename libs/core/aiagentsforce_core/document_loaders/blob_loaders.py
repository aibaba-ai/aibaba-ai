...
from aiagentsforce_core.documents.base import Blob as Blob
from aiagentsforce_core.documents.base import PathLike as PathLike
...
class BlobLoader(ABC):
    ...
    def yield_blobs(
        ...
        """A lazy loader for raw data represented by AI Agents Force's Blob object.
