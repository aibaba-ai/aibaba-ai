...
from aiagentsforce_core.globals import get_llm_cache
...
from aiagentsforce_core.prompt_values import ChatPromptValue, PromptValue, StringPromptValue
from aiagentsforce_core.rate_limiters import BaseRateLimiter
from aiagentsforce_core.runnables import RunnableMap, RunnablePassthrough
from aiagentsforce_core.runnables.config import ensure_config, run_in_executor
...
if TYPE_CHECKING:
    ...
    from aiagentsforce_core.runnables import Runnable, RunnableConfig
...
class BaseChatModel(BaseLanguageModel[BaseMessage], ABC):
    ...
    Creating custom chat model:
        ...
        [Guide](https://docs.aiagentsforce.com/docs/how_to/custom_chat_model/).
