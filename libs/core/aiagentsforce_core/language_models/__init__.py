...
AI Agents Force has two main classes to work with language models: **Chat Models**
...
should inherit from this class. Please see AI Agents Force how-to guides with more
...
https://docs.aiagentsforce.com/docs/how_to/custom_chat_model/
...
Although the underlying models are string in, string out, the AI Agents Force wrappers
...
https://docs.aiagentsforce.com/docs/how_to/custom_llm/


"""  # noqa: E501

from aiagentsforce_core.language_models.base import (
    BaseLanguageModel,
    LangSmithParams,
    LanguageModelInput,
    LanguageModelLike,
...
from aiagentsforce_core.language_models.chat_models import BaseChatModel, SimpleChatModel
from aiagentsforce_core.language_models.fake import FakeListLLM, FakeStreamingListLLM
...
from aiagentsforce_core.language_models.llms import LLM, BaseLLM
