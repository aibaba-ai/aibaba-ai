...
from aiagentsforce_core.load.mapping import (
...
def loads(
    ...
    *,
    ...
    """Revive a AI Agents Force class from a JSON string.
    ...
    Returns:
        Revived AI Agents Force objects.
    """
    return json.loads(
        text,
        object_hook=Reviver(
...
def load(
    ...
    *,
    ...
    """Revive a AI Agents Force class from a JSON object. Use this if you already
