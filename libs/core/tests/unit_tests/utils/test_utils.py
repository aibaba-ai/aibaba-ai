...
from aibaba_ai_core import utils
...
from aibaba_ai_core.utils._merge import merge_dicts
from aibaba_ai_core.utils.pydantic import PYDANTIC_MAJOR_VERSION
from aibaba_ai_core.utils.utils import secret_from_env
...
def test_check_package_version(
    ...
    with patch("aibaba_ai_core.utils.utils.version", return_value=actual_version):
        if expected is None:
...
@pytest.mark.parametrize(
    ...
    [
        ("aibaba_ai_core.utils", None, None, utils),
        ("aibaba_ai_core.utils", "langchain-core", None, utils),
        ("aibaba_ai_core.utils", None, "langchain-core", utils),
        ("aibaba_ai_core.utils", "langchain-core", "langchain-core", utils),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("aibaba_ai_core.utilsW", None, None),
        ("aibaba_ai_core.utilsW", "langchain-core-2", None),
        ("aibaba_ai_core.utilsW", None, "langchain-coreWX"),
        ("aibaba_ai_core.utilsW", "langchain-core-2", "langchain-coreWX"),
