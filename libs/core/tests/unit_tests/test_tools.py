...
from aibaba_ai_core import tools
...
from aibaba_ai_core.messages import ToolCall, ToolMessage
from aibaba_ai_core.messages.tool import ToolOutputMixin
...
from aibaba_ai_core.utils.pydantic import PYDANTIC_MAJOR_VERSION, _create_subset_model
...
def test_structured_tool_with_different_pydantic_versions(pydantic_model: Any) -> None:
    """This should test that one can type the args schema as a pydantic model."""
    from aibaba_ai_core.tools import StructuredTool
