...
from aibaba_ai_core.output_parsers.list import CommaSeparatedListOutputParser
...
from aibaba_ai_core.runnables.base import Runnable, RunnableConfig
from aibaba_ai_core.runnables.graph import Edge, Graph, Node
from aibaba_ai_core.runnables.graph_mermaid import _escape_node_label
    ...
    assert graph.to_json() == {
        "nodes": [
            ...
            },
            {
                ...
                "type": "runnable",
                "data": {
                    "id": ["aibaba_ai_core", "language_models", "fake", "FakeListLLM"],
                    "name": "FakeListLLM",
                },
                "metadata": {"key": 2},
            },
