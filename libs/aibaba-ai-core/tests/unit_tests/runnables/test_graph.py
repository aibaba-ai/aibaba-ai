...
from aibaba-ai-core.output_parsers.list import CommaSeparatedListOutputParser
from aibaba-ai-core.output_parsers.string import StrOutputParser
from aibaba-ai-core.output_parsers.xml import XMLOutputParser
from aibaba-ai-core.prompts.prompt import PromptTemplate
from aibaba-ai-core.runnables.base import Runnable, RunnableConfig
from aibaba-ai-core.runnables.graph import Edge, Graph, Node
from aibaba-ai-core.runnables.graph_mermaid import _escape_node_label
    ...
    assert graph.to_json() == {
        "nodes": [
            ...
            },
            {
                ...
                "type": "runnable",
                "data": {
                    "id": ["aibaba-ai-core", "language_models", "fake", "FakeListLLM"],
                    "name": "FakeListLLM",
                },
                "metadata": {"key": 2},
            },
