...
from aibaba-ai-core.load import Serializable, dumpd, load
from aibaba-ai-core.load.serializable import _is_field_useful
...
def test_simple_serialization_secret() -> None:
    ...
    from aibaba-ai-core.load import Serializable
