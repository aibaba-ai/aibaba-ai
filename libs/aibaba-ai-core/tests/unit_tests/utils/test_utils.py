...
from aibaba-ai-core import utils
...
from aibaba-ai-core.utils._merge import merge_dicts
from aibaba-ai-core.utils.pydantic import PYDANTIC_MAJOR_VERSION
from aibaba-ai-core.utils.utils import secret_from_env
...
def test_check_package_version(
    ...
    with patch("aibaba-ai-core.utils.utils.version", return_value=actual_version):
        if expected is None:
...
@pytest.mark.parametrize(
    ...
    [
        ("aibaba-ai-core.utils", None, None, utils),
        ("aibaba-ai-core.utils", "langchain-core", None, utils),
        ("aibaba-ai-core.utils", None, "langchain-core", utils),
        ("aibaba-ai-core.utils", "langchain-core", "langchain-core", utils),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("aibaba-ai-core.utilsW", None, None),
        ("aibaba-ai-core.utilsW", "langchain-core-2", None),
        ("aibaba-ai-core.utilsW", None, "langchain-coreWX"),
        ("aibaba-ai-core.utilsW", "langchain-core-2", "langchain-coreWX"),
