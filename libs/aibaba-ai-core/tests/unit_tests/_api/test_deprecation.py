...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "`SomeFunction` was deprecated in Aibaba AI 1.5.0 and will be "
...
def test_deprecated_function() -> None:
    ...
    with warnings.catch_warnings(record=True) as warning_list:
        ...
        warning = warning_list[0].message
        assert str(warning) == (
            "The function `deprecated_function` was deprecated in Aibaba AI 2.0.0 "
...
async def test_deprecated_async_function() -> None:
    ...
    with warnings.catch_warnings(record=True) as warning_list:
        ...
        assert str(warning) == (
            ...
            "in Aibaba AI 2.0.0 and will be removed in 3.0.0"
        )
