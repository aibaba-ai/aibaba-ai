...
import pytest
from aibaba-ai-core.prompt_values import PromptValue, StringPromptValue
from aibaba-ai-core.runnables import Runnable, RunnableLambda, RunnablePassthrough
