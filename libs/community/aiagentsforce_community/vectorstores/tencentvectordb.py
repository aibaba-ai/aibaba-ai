...
from aiagentsforce_core.utils import guard_import
...
def translate_filter(
    ...
    """Translate AI Agents Force filter to Tencent VectorDB filter.

    Args:
        lc_filter (str): AI Agents Force filter.
    ...
    from aiagentsforce_core.structured_query import FilterDirective
...
class TencentVectorDB(VectorStore):
    ...
    def __init__(
        ...
        database_name: str = "AI Agents ForceDatabase",
        collection_name: str = "AI Agents ForceCollection",
        drop_old: Optional[bool] = False,
        collection_description: Optional[str] = "Collection for AI Agents Force",
