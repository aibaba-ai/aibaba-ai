...
import numpy as np
import sqlalchemy
from aiagentsforce_core._api import deprecated, warn_deprecated
...
@deprecated(
    ...
    message=(
        ...
        "See <https://github.com/AI-Agents-Force-SDK/langchain-postgres> for details about "
...
class PGVector(VectorStore):
    ...
    **DEPRECATED**: This class is pending deprecation and will likely receive
    ...
    def create_vector_extension(self) -> None:
        try:
            with Session(self._bind) as session:  # type: ignore[arg-type]
                ...
                # https://github.com/AI-Agents-Force-SDK/langchain/issues/12933
    ...
    def _create_filter_clause(self, filters: Any) -> Any:
        """Convert AI Agents Force IR filter representation to matching SQLAlchemy clauses.
