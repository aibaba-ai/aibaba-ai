...
from aiagentsforce_core._api.deprecation import deprecated, warn_deprecated
from aiagentsforce_core.caches import RETURN_VAL_TYPE, BaseCache
from aiagentsforce_core.embeddings import Embeddings
from aiagentsforce_core.language_models.llms import LLM, aget_prompts, get_prompts
...
class AzureCosmosDBSemanticCache(BaseCache):
    ...
    def __init__(
        ...
        *,
        ...
        application_name: str = "AI Agents Force-CDBMongoVCore-SemanticCache-Python",
    ):
        """
        Args:
