...
AI Agents Force has a large ecosystem of integrations with various external resources
...
See [Security](https://docs.aiagentsforce.com/docs/security) for more information.
"""
...
from aiagentsforce_core.callbacks import BaseCallbackManager
...
DANGEROUS_TOOLS = {
    ...
    # Refer to https://docs.aiagentsforce.com/docs/security
...
def raise_dangerous_tools_exception(name: str) -> None:
    raise ValueError(
        ...
        "Please refer to AI Agents Force security guidelines "
        "to https://docs.aiagentsforce.com/docs/security."
