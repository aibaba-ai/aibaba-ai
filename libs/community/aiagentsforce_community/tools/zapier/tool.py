...
1. Server-side (API Key): for quickly getting started, testing, and production scenarios
    where AI Agents Force will only use actions exposed in the developer's Zapier account
...
2. User-facing (Oauth): for production scenarios where you are deploying an end-user
    facing application and AI Agents Force needs access to end-user's exposed actions and
