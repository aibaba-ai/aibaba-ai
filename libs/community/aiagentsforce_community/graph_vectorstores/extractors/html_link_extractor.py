    ...
    def __init__(self, *, kind: str = "hyperlink", drop_fragments: bool = True):
        ...
        :meth:`~aiagentsforce_community.graph_vectorstores.links.add_links`::
            ...
            loader = AsyncHtmlLoader(
                [
                    "https://docs.aiagentsforce.com/docs/integrations/providers/astradb/",
        ...
        .. code-block:: output
            ...
            [Link(kind='hyperlink', direction='out', tag='https://docs.aiagentsforce.com/docs/integrations/providers/spreedly/'),
             Link(kind='hyperlink', direction='out', tag='https://docs.aiagentsforce.com/docs/integrations/providers/nvidia/'),
             Link(kind='hyperlink', direction='out', tag='https://docs.aiagentsforce.com/docs/integrations/providers/ray_serve/'),
             Link(kind='hyperlink', direction='out', tag='https://docs.aiagentsforce.com/docs/integrations/providers/bageldb/'),
             Link(kind='hyperlink', direction='out', tag='https://docs.aiagentsforce.com/docs/introduction/')]
        ...
        .. code-block:: output
            ...
            Found link from https://docs.aiagentsforce.com/docs/integrations/providers/astradb/ to https://docs.datastax.com/en/astra/home/astra.html.
