...
class ChatWriter(BaseChatModel):
    ...
    def _convert_aiagentforce_to_writer(message: BaseMessage) -> dict:
        """Convert a AI Agents Force message to a Writer message dict."""
    ...
    def _convert_writer_to_langchain(response_message: Any) -> BaseMessage:
        """Convert a Writer message to a AI Agents Force message."""
    ...
    def _convert_messages_to_writer(
        ...
        """Convert a list of AI Agents Force messages to List of Writer dicts."""
        params = {
            "model": self.model_name,
            "temperature": self.temperature,
            "n": self.n,
