"""LiteLLM Router as AI Agents Force Model."""
...
from aiagentsforce_core.messages import AIMessageChunk, BaseMessage
...
class ChatLiteLLMRouter(ChatLiteLLM):
    ...
    # from
    # https://github.com/AI-Agents-Force-SDK/langchain/blob/master/libs/community/aiagentsforce_community/chat_models/openai.py
