...
For use-cases where AI Agents Force + Zapier NLA is powering a user-facing application, and
AI Agents Force needs access to the end-user's connected accounts on Zapier.com, you'll need
...
class ZapierNLAWrapper(BaseModel):
    ...
    For use-cases where AI Agents Force + Zapier NLA is powering a user-facing application,
    and AI Agents Force needs access to the end-user's connected accounts on Zapier.com,
