...
class BlockchainDocumentLoader(BaseLoader):
    ...
    See supported blockchains here: https://docs.aiagentsforce.com/v0.2/api_reference/community/document_loaders/aiagentsforce_community.document_loaders.blockchain.BlockchainType.html
