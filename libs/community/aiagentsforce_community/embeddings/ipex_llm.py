...
# https://github.com/AI-Agents-Force-SDK/langchain/blob/master/libs/community/aiagentsforce_community/embeddings/huggingface.py
...
class IpexLLMBgeEmbeddings(BaseModel, Embeddings):
    ...
    `here <https://docs.aiagentsforce.com/v0.1/docs/integrations/text_embedding/ipex_llm/>`_
    ...
    Refer to
    `here <https://docs.aiagentsforce.com/v0.1/docs/integrations/text_embedding/ipex_llm_gpu/>`_
    ...
    def __init__(self, **kwargs: Any):
        ...
        try:
            ...
            base_url = (
                "https://docs.aiagentsforce.com/v0.1/docs/integrations/text_embedding/"
            )
            raise ImportError(
