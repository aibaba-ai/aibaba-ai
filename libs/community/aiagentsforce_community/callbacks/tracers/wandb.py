...
from aiagentsforce_core.output_parsers.pydantic import PydanticBaseModel
...
class WandbTracer(BaseTracer):
    ...
    This will ensure that all AI Agents Force activity is logged to W&B.
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        To use W&B to monitor all AI Agents Force activity, add this tracer like any other
        AI Agents Force callback:
        ```
        ...
        warn_deprecated(
            ...
            message=(
                ...
                "and tracing your AI Agents Force callables."
            ...
            alternative=(
                ...
                "from your AI Agents Force callables."
            ),
        )
    ...
    def _ensure_run(self, should_print_url: bool = False) -> None:
        ...
        if self._wandb.run is not None:
            if should_print_url:
                ...
                self._wandb.termlog(
                    f"Streaming AI Agents Force activity to W&B at {run_url}\n"
    ...
    def _log_trace_from_run(self, run: Run) -> None:
        """Logs a AI Agents Force Run to W*B as a W&B Trace."""
        self._ensure_run()
