...
from aiagentsforce_core.utils import get_from_dict_or_env, get_from_env
...
class AzureAISearchRetriever(BaseRetriever):
    ...
    Setup:
        See here for more detail: https://docs.aiagentsforce.com/docs/integrations/retrievers/azure_ai_search/
