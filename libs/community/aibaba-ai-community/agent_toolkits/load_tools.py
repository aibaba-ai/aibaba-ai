...
from aibaba-ai-core.callbacks import BaseCallbackManager
from aibaba-ai-core.callbacks import Callbacks
...
DANGEROUS_TOOLS = {
    ...
    # Refer to https://docs.aibaba.world/docs/security
...
def raise_dangerous_tools_exception(name: str) -> None:
    raise ValueError(
        ...
        "Please refer to Aibaba AI security guidelines "
        "to https://docs.aibaba.world/docs/security."
