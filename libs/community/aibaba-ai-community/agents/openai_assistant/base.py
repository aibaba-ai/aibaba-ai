...
from aibaba-ai-core.load import dumpd
from aibaba-ai-core.runnables import RunnableConfig, ensure_config
...
class OpenAIAssistantV2Runnable(OpenAIAssistantRunnable):
    ...
    Attributes:
        ...
        as_agent (bool): Whether to use the assistant as a Aibaba AI agent.
    ...
    Example using custom tools and custom execution:
        .. code-block:: python
            ...
            from langchain.agents.openai_assistant import OpenAIAssistantV2Runnable
            from langchain.agents import AgentExecutor
            from aibaba-ai-core.agents import AgentFinish
            from langchain.tools import E2BDataAnalysisTool
    ...
    as_agent: bool = False
    """Use as a Aibaba AI agent, compatible with the AgentExecutor."""
