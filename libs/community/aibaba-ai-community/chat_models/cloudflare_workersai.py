...
from aibaba-ai-core.runnables import Runnable, RunnablePassthrough
from aibaba-ai-core.runnables.base import RunnableMap
...
def _convert_messages_to_cloudflare_messages(
    ...
    """Convert Aibaba AI messages to Cloudflare Workers AI format."""
    cloudflare_messages = []
    msg: Dict[str, Any]
