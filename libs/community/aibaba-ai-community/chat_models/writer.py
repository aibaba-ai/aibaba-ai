...
class ChatWriter(BaseChatModel):
    ...
    @staticmethod
    def _convert_aiagentforce_to_writer(message: BaseMessage) -> dict:
        """Convert a Aibaba AI message to a Writer message dict."""
    ...
    def _convert_writer_to_langchain(response_message: Any) -> BaseMessage:
        """Convert a Writer message to a Aibaba AI message."""
    ...
    def _convert_messages_to_writer(
        ...
        """Convert a list of Aibaba AI messages to List of Writer dicts."""
        params = {
            "model": self.model_name,
            "temperature": self.temperature,
            "n": self.n,
        ...
        message_dicts = [self._convert_aiagentforce_to_writer(m) for m in messages]
