...
class IpexLLMBgeEmbeddings(BaseModel, Embeddings):
    ...
    `here <https://docs.aibaba.world/v0.1/docs/integrations/text_embedding/ipex_llm/>`_
    ...
    Refer to
    `here <https://docs.aibaba.world/v0.1/docs/integrations/text_embedding/ipex_llm_gpu/>`_
    ...
    def __init__(self, **kwargs: Any):
        ...
        try:
            ...
            base_url = (
                "https://docs.aibaba.world/v0.1/docs/integrations/text_embedding/"
            )
            raise ImportError(
