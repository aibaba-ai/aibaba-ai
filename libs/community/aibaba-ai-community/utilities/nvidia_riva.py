...
from aibaba-ai-core.messages import AnyMessage, BaseMessage
from aibaba-ai-core.prompt_values import PromptValue
from aibaba-ai-core.runnables import RunnableConfig, RunnableSerializable
...
def _coerce_string(val: "TTSInputType") -> str:
    ...
    This is particularly useful for converting Aibaba AI message to strings.
    """
