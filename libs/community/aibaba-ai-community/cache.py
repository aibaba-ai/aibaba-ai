...
from aibaba-ai-core._api.deprecation import deprecated, warn_deprecated
from aibaba-ai-core.caches import RETURN_VAL_TYPE, BaseCache
from aibaba-ai-core.embeddings import Embeddings
from aibaba-ai-core.language_models.llms import LLM, aget_prompts, get_prompts
...
from aibaba-ai-core.utils import get_from_env
...
class CassandraCache(BaseCache):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from aibaba-ai-core.globals import set_llm_cache
...
class AzureCosmosDBSemanticCache(BaseCache):
    ...
    def __init__(
        ...
        *,
        ...
        application_name: str = "Aibaba AI-CDBMongoVCore-SemanticCache-Python",
    ):
        """
        Args:
