...
from aibaba-ai-core.utils import get_from_dict_or_env, get_from_env
...
class AzureAISearchRetriever(BaseRetriever):
    ...
    Setup:
        See here for more detail: https://docs.aibaba.world/docs/integrations/retrievers/azure_ai_search/
    ...
    Use within a chain:
        .. code-block:: python
            ...
            from aibaba-ai-core.runnables import RunnablePassthrough
