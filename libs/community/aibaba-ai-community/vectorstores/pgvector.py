...
import numpy as np
import sqlalchemy
from aibaba-ai-core._api import deprecated, warn_deprecated
...
@deprecated(
    ...
    message=(
        ...
        "See <https://github.com/aibaba-ai/aibaba-ai-postgres> for details about "
...
class PGVector(VectorStore):
    ...
    **DEPRECATED**: This class is pending deprecation and will likely receive
    ...
    def create_vector_extension(self) -> None:
        try:
            with Session(self._bind) as session:  # type: ignore[arg-type]
                ...
                # https://github.com/aibaba-ai/aibaba-ai/issues/12933
    ...
    def _create_filter_clause(self, filters: Any) -> Any:
        """Convert Aibaba AI IR filter representation to matching SQLAlchemy clauses.
