...
from aibaba-ai-core.exceptions import AI Agents ForceException
...
class AzureSearch(VectorStore):
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        # https://github.com/aibaba-ai/aibaba-ai/blob/4cdaca67dc51dba887289f56c6fead3c1a52f97d/libs/core/aibaba-ai-core/vectorstores/base.py#L65
        ...
        for i, (text, embedding) in enumerate(text_embeddings):
            ...
            if len(data) == MAX_UPLOAD_BATCH_SIZE:
                ...
                if not all(r.succeeded for r in response):
                    raise AI Agents ForceException(response)
                # Reset data
                data = []
