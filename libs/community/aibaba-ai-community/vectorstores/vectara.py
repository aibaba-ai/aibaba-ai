...
from aibaba-ai-core.runnables import Runnable, RunnableConfig
from aibaba-ai-core.vectorstores import VectorStore, VectorStoreRetriever
...
class Vectara(VectorStore):
    ...
    def add_files(
        ...
        **kwargs: Any,
        ...
        This method provides a way to use that API in Aibaba AI
