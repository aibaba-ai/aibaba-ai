...
from aibaba_ai_community.document_loaders.lakefs import LakeFSLoader


@pytest.fixture
def mock_lakefs_client() -> Any:
    with patch(
        "aibaba_ai_community.document_loaders.lakefs.LakeFSClient"
...
def mock_unstructured_local() -> Any:
    with patch(
        "aibaba_ai_community.document_loaders.lakefs.UnstructuredLakeFSLoader"
