    ...
    def __init__(self, *, kind: str = "hyperlink", drop_fragments: bool = True):
        ...
        :meth:`~aibaba_ai_community.graph_vectorstores.links.add_links`::
            ...
            loader = AsyncHtmlLoader(
                [
                    "https://docs.aibaba.world/docs/integrations/providers/astradb/",
        ...
        .. code-block:: output
            ...
            [Link(kind='hyperlink', direction='out', tag='https://docs.aibaba.world/docs/integrations/providers/spreedly/'),
             Link(kind='hyperlink', direction='out', tag='https://docs.aibaba.world/docs/integrations/providers/nvidia/'),
             Link(kind='hyperlink', direction='out', tag='https://docs.aibaba.world/docs/integrations/providers/ray_serve/'),
             Link(kind='hyperlink', direction='out', tag='https://docs.aibaba.world/docs/integrations/providers/bageldb/'),
             Link(kind='hyperlink', direction='out', tag='https://docs.aibaba.world/docs/introduction/')]
