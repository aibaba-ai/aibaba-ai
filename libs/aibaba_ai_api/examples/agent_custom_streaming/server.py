...
other examples in aiagentsforceapi for how to use RunnableWithHistory to store history
on the server side.
...
Please see configurable_agent_executor: https://github.com/aibaba-aiaiagentsforceapi/blob/main/examples/configurable_agent_executor/server.py
for an example that uses a custom runnable with configurable fields.

Relevant LangChain documentation:

* Creating a custom agent: https://docs.aibaba.world/modules/agents/how_to/custom_agent
* Streaming with agents: https://docs.aibaba.world/modules/agents/how_to/streaming#custom-streaming-with-events
* General streaming documentation: https://docs.aibaba.world/expression_language/streaming
* Message History: https://docs.aibaba.world/expression_language/how_to/message_history
