...
class SharedResponseMetadata(BaseModelV1):
    ...
    representing a aiagentsforceapi response shared across all outputs in said
    response.
    """
...
class InvokeResponseMetadata(SharedResponseMetadata):
    """Represents response metadata used for just single input/output aiagentsforceapi
    responses.
    """
...
class BatchResponseMetadata(SharedResponseMetadata):
    """
    Represents response metadata used for batches of input/output aiagentsforceapi
    responses.
    """
