...
def _setup_global_app_handlers(
    ...
    """  # noqa: E501
            ...
            print(aiagentsforceapi)
            for path in paths:
                if endpoint_configuration.is_playground_enabled:
                    print(
                        f'{green("aiagentsforceapi:")} Playground for chain "{path or ""}/" '
                        f'is live at:'
                    )
                    print(f'{green("aiagentsforceapi:")}  │')
                    print(f'{green("aiagentsforceapi:")}  └──> {path}/playground/')
                    print(f'{green("aiagentsforceapi:")}')
            print(f'{green("aiagentsforceapi:")} See all available routes at {app.docs_url}/')
...
def add_routes(
    ...
    * /config_schema - for returning the config schema of the runnable
    ...
    Args:
        ...
        playground_type: The type of playground to serve. The default is "default".
            ...
            - chat: UX is optimized for chat-like interactions. Please review
              the README in aiagentsforceapi for more details about constraints (e.g.,
    ...
    # This is done so that folks can upgrade aiagentsforceapi without having to
                ...
                *(getattr(app, "openapi_tags", []) or []),
                default_endpoint_tags,
                {
                    ...
                    "description": (
                        ...
                        "aiagentsforceapi UI playground. "
