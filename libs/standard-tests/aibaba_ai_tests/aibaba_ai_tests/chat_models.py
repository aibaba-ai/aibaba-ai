...
import httpx
import pytest
from aibaba_ai_core.language_models import BaseChatModel, GenericFakeChatModel
...
from aibaba_ai_core.utils.function_calling import tool_example_to_messages
...
class ChatModelIntegrationTests(ChatModelTests):
    ...
    .. dropdown:: returns_usage_metadata
        ...
        and output tokens: https://docs.aibaba.world/api_reference/core/messages/aibaba_ai_core.messages.ai.UsageMetadata.html
    ...
    def test_invoke(self, model: BaseChatModel) -> None:
        ...
        .. dropdown:: Troubleshooting
            ...
            :class:`~aibaba_ai_core.outputs.chat_result.ChatResult` like so:
    ...
    def test_stream(self, model: BaseChatModel) -> None:
        ...
        .. dropdown:: Troubleshooting
            ...
            :class:`~aibaba_ai_core.outputs.chat_generation.ChatGenerationChunk`
            objects like so:
    ...
    def test_batch(self, model: BaseChatModel) -> None:
        ...
        .. dropdown:: Troubleshooting
            ...
            :class:`~aibaba_ai_core.messages.AIMessage` objects.
        """
    ...
    def test_conversation(self, model: BaseChatModel) -> None:
        ...
        .. dropdown:: Troubleshooting
            ...
            3. The response is a valid :class:`~aibaba_ai_core.messages.AIMessage`
        """
        messages = [
            HumanMessage("hello"),
            AIMessage("hello"),
    ...
    def test_usage_metadata(self, model: BaseChatModel) -> None:
        ...
        .. dropdown:: Troubleshooting
            ...
            :class:`~aibaba_ai_core.messages.ai.UsageMetadata` dicts
    ...
    def test_structured_output(self, model: BaseChatModel) -> None:
        ...
        .. dropdown:: Troubleshooting
            ...
            ``aibaba_ai_core`` implements a utility function that will accommodate
            most formats: https://docs.aibaba.world/api_reference/core/utils/aibaba_ai_core.utils.function_calling.convert_to_openai_tool.html
    ...
    def test_structured_output_pydantic_2_v1(self, model: BaseChatModel) -> None:
        ...
        class Joke(BaseModelV1):  # Uses aibaba_ai_core.pydantic_v1.BaseModel
            """Joke to tell user."""
    ...
    def test_structured_few_shot_examples(
        ...
        .. dropdown:: Troubleshooting
            ...
            This test uses a utility function in ``aibaba_ai_core`` to generate a
            sequence of messages representing "few-shot" examples: https://docs.aibaba.world/api_reference/core/utils/aibaba_ai_core.utils.function_calling.tool_example_to_messages.html
