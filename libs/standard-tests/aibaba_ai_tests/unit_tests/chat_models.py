...
from aibaba_ai_core.load import dumpd, load
...
class ChatModelUnitTests(ChatModelTests):
    ...
    def test_bind_tool_pydantic(
        ...
        .. dropdown:: Troubleshooting
            ...
            properly handles Pydantic V2 models. ``aibaba_ai_core`` implements
            a utility function that will accommodate most formats: https://docs.aibaba.world/api_reference/core/utils/aibaba_ai_core.utils.function_calling.convert_to_openai_tool.html
